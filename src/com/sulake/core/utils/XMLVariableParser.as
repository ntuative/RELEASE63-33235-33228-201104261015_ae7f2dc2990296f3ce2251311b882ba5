package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1750:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1646:String = "bool";
      ...
      private static const const_1859:String = "HabboRoomObjectLogicLib_manifest";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_261 || _loc5_ == const_138)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1750:
               return Number(param1);
            case const_39:
               return param1 == const_659 || int(param1) > 0;
            case const_1646:
               return param1 == const_659 || int(param1) > 0;
            case const_153:
               return uint(param1);
            case const_138:
               return param1.split(const_1413);
            default:
