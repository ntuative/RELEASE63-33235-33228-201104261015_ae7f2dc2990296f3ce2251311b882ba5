package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_506:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_506 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_103 is BitmapDataAsset)
         {
            ...
            this.var_1365 = BitmapDataAsset(this.var_103).var_1365;
            this.var_1366 = BitmapDataAsset(this.var_103).var_1366;
            if(this._bitmap != null)
            {
               this.var_103 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1365 = _loc4_ == "1" || _loc4_ == "HabboAvatarRenderLib_HabboAvatarPetActions";
                  break;
               case "flipV":
                  this.var_1366 = _loc4_ == "1" || _loc4_ == "HabboAvatarRenderLib_HabboAvatarPetActions";
                  break;
            }
            _loc2_++;
         }
