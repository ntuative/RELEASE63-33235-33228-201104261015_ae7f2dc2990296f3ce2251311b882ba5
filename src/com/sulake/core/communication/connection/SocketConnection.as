package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1620:int = 10000;
      ...
      private var var_524:ByteArray;
      
      private var var_1208:IEncryption;
      
      private var var_789:IProtocol;
      
      private var _id:String;
      
      private var var_1209:IMessageClassManager;
      
      private var var_255:ICoreCommunicationManager;
      
      private var var_525:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_255 = param2;
         this.var_524 = new ByteArray();
         this.var_1209 = new MessageClassManager();
         this.var_79 = new Socket();
         this.var_372 = new Timer(const_1620,1);
         this.var_372.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_525)
         {
            this.var_525.connectionInit(param1,param2);
         }
      ...
      {
         this.var_372.delay = param1;
      }
      
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         this.var_255.addConnectionMessageEvent(this._id,param1);
      }
      
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         this.var_255.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1209.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_525)
         {
            this.var_525.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1208 != null)
         {
            _loc3_ = this.var_1208.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1209.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1208 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_789.getMessages(this.var_524,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_525)
               {
                  this.var_525.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1209.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_255.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_255.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_524,offset);
               this.var_524 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_524.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_524.writeByte(this.var_79.readUnsignedByte());
         }
      }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_372.delay + " ms). Possible Firewall.";
