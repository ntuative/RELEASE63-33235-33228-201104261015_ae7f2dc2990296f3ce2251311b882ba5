package com.sulake.core.communication.messages
{
   ...
   public class MessageDataWrapper implements IMessageDataWrapper
   {
      ...
      private var var_1142:IProtocolDecoder;
      ...
      {
         return this.var_1142.readString(this._data);
      }
      
      public function readInteger() : int
      {
         return this.var_1142.readInteger(this._data);
      }
      
      public function readBoolean() : Boolean
      {
         return this.var_1142.readBoolean(this._data);
      }
      
      public function readShort() : Short
      {
         return this.var_1142.readShort(this._data);
      }
