package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_141:String = "WME_DOUBLE_CLICK";
      
      public static const const_42:String = "WME_DOWN";
      
      public static const const_1958:String = "WME_MIDDLE_CLICK";
      
      public static const const_1999:String = "WME_MIDDLE_DOWN";
      
      public static const const_2005:String = "WME_MIDDLE_UP";
      ...
      public static const const_1902:String = "WME_RIGHT_CLICK";
      
      public static const const_1962:String = "WME_RIGHT_DOWN";
      
      public static const const_1973:String = "WME_RIGHT_UP";
      
      public static const const_1541:String = "WME_ROLL_OUT";
      
      public static const const_1621:String = "WME_ROLL_OVER";
      
      public static const const_537:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_703 = param3;
         _loc13_.var_474 = false;
         _loc13_.var_704 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_470 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
