package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_1228:String = null;
      
      private var var_1937:StyleSheet = null;
      ...
      {
         this.var_798 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1228 == param2)
         {
            return;
         }
         param1.var_1228 = param2;
         param1.var_1937 = null;
         if(param1.var_1228 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1228);
            param1.var_1937 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_946.indexOf(param1) > -1)
         {
            this.var_798 = param1;
         }
      }
      ...
      {
         return this.var_798 == LinkTarget.const_30 ? defaultLinkTarget : this.var_798;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1937;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_798 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_870,this.var_798,PropertyStruct.const_55,true,PropertyDefaults.const_946));
         }
         else
         {
