package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2123:Boolean = false;
      ...
      protected var var_697:Number = -1.0;
      ...
      protected var var_2121:int = 0;
      
      protected var var_2122:int = 0;
      
      protected var var_1330:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this._container = _context.create("_CONTAINER","",WindowType.const_424,WindowStyle.const_173,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1328;
      }
      ...
      {
         return new Rectangle(this.var_699 * this.maxScrollH,this.var_700 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_699 = param1;
            this._container.x = -this.var_699 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_60);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_526,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_586,param1);
            }
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_192:
               if(this.var_1329)
               {
                  this.var_1330 = this.var_2121 - _loc3_;
                  this.var_1327 = this.var_2122 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1330 != 0 && this.var_109 != 0)
                     {
                        this.scrollH += this.var_1330 / this.var_109;
                     }
                  }
                  else if(this.var_1327 != 0 && this.var_96 != 0)
                  {
                     this.scrollV += this.var_1327 / this.var_96;
                  }
                  this.var_2121 = _loc3_;
                  this.var_2122 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_207:
               if(this.var_1329)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1330,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1327);
                  }
                  this.var_1329 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1070 && !this.var_568 && this._container)
         {
            this.var_568 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(PropertyDefaults.const_1137);
         }
         if(this.var_1070 != PropertyDefaults.const_1212)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_784,this.var_1070,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1614);
         }
         if(this.var_469 != PropertyDefaults.const_1195)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_858,this.var_469,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1723);
         }
         if(this.var_1328 != PropertyDefaults.const_1151)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_825,this.var_1328,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1526);
         }
         if(this.var_698 != PropertyDefaults.const_1220)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_798,this.var_698,PropertyStruct.const_133,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1776);
         }
         if(this.var_697 != PropertyDefaults.const_1145)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_721,this.var_697,PropertyStruct.const_133,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1534);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_798:
                  ...
                  break;
               case PropertyDefaults.const_721:
                  this.var_697 = _loc2_.value as Number;
                  break;
            }
         }
