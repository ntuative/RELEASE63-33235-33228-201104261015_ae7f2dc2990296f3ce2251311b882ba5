package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1491:String = "_SELECTOR";
      
      private static const const_1492:String = "_CONTENT";
       
      
      protected var var_1079:ITabSelectorWindow;
      
      protected var var_2141:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1079 = findChildByTag(const_1491) as ITabSelectorWindow;
            if(this.var_1079 != null)
            {
               this.var_1079.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2141 = findChildByTag(const_1492) as IWindowContainer;
         }
      ...
      {
         return this.var_1079.numSelectables;
      }
