package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_393:Object = null;
      ...
      {
         return this.var_393 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_428);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_393 != null)
            {
               _loc1_.textColor = uint(this.var_393);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_428 != param1.name)
         {
            this.var_428 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2859 = _loc2_.textWidth;
         this.var_2858 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_393 != _loc2_.color : this.var_393 != null && this.var_393 != PropertyDefaults.const_783) ? new PropertyStruct(PropertyDefaults.const_428,this.var_393,PropertyStruct.const_153,true) : PropertyDefaults.const_1127);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_750)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_250,this.var_42.left,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_494);
            }
            if(this.var_42.top != PropertyDefaults.const_897)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_265,this.var_42.top,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_599);
            }
            if(this.var_42.right != PropertyDefaults.const_795)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,this.var_42.right,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_633);
            }
            if(this.var_42.bottom != PropertyDefaults.const_735)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_245,this.var_42.bottom,PropertyStruct.const_43,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_428:
                  this.var_393 = _loc2_.value as uint;
                  break;
