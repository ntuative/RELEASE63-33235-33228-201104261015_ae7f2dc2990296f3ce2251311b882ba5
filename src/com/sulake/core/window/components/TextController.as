package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1310:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_871:Number;
      ...
      private var var_428:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_428,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_428 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_428,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      {
         return TextStyleManager.getStyle(this.var_428);
      }
      ...
      {
         this.var_871 = param1;
         this._field.scrollH = this.var_871 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_871 * this.maxScrollH,this.var_573 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_428);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_864,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1298));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1265 ? new PropertyStruct(PropertyDefaults.const_851,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1165) : PropertyDefaults.const_1809);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1240 ? new PropertyStruct(PropertyDefaults.const_1194,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1203) : PropertyDefaults.const_1594);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_783) ? new PropertyStruct(PropertyDefaults.const_428,this._field.textColor,PropertyStruct.const_153,true) : PropertyDefaults.const_1127);
         _loc1_.push(this.var_428 != TextStyleManager.const_217 ? new PropertyStruct(PropertyDefaults.const_383,this.var_428,PropertyStruct.const_55,true,PropertyDefaults.const_704) : PropertyDefaults.const_1174);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_750 ? new PropertyStruct(PropertyDefaults.const_250,this.var_42.left,PropertyStruct.const_43,true) : PropertyDefaults.const_494);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_897 ? new PropertyStruct(PropertyDefaults.const_265,this.var_42.top,PropertyStruct.const_43,true) : PropertyDefaults.const_599);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_795 ? new PropertyStruct(PropertyDefaults.const_255,this.var_42.right,PropertyStruct.const_43,true) : PropertyDefaults.const_633);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_735 ? new PropertyStruct(PropertyDefaults.const_245,this.var_42.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_606);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1093 ? new PropertyStruct(PropertyDefaults.const_906,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1812);
