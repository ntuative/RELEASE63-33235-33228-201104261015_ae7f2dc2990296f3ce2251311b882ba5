package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_474)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_474)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_708,param1.toolTipCaption,PropertyStruct.const_55,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1766);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1217)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_802,param1.toolTipDelay,PropertyStruct.const_285,true));
         }
         else
         {
      ...
      {
         this.var_1333 = param1 == null ? "null" : param1;
      }
