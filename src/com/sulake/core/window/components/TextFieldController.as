package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1608:uint = 500;
      ...
      {
         this.var_1333 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1085,var_11);
         }
         return var_21;
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_329,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_954,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1527);
         _loc1_.push(this.var_1339 != PropertyDefaults.const_1304 ? new PropertyStruct(PropertyDefaults.const_733,this.var_1339,PropertyStruct.const_39,true) : PropertyDefaults.const_1801);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1167 ? new PropertyStruct(PropertyDefaults.const_929,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1600);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1125 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1659);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_733:
                  this.var_1339 = _loc2_.value as Boolean;
                  if(this.var_1339)
                  {
               ...
               case PropertyDefaults.const_954:
                  ...
                  break;
               case PropertyDefaults.const_1192:
