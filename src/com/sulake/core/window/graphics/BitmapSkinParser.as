package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_116:String = "active";
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "HabboAvatarRenderLib_HabboAvatarPetActions";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "HabboAvatarRenderLib_HabboAvatarPetActions";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_396 = SkinLayoutEntity.const_561;
                  break;
               case "move":
                  _loc5_.var_396 = SkinLayoutEntity.const_307;
                  break;
               case "strech":
                  _loc5_.var_396 = SkinLayoutEntity.const_527;
                  break;
               case "tiled":
                  _loc5_.var_396 = SkinLayoutEntity.const_361;
                  break;
               case "center":
            ...
            {
               case "fixed":
                  _loc5_.var_398 = SkinLayoutEntity.const_561;
                  break;
               case "move":
                  _loc5_.var_398 = SkinLayoutEntity.const_307;
                  break;
               case "strech":
                  _loc5_.var_398 = SkinLayoutEntity.const_527;
                  break;
               case "tiled":
                  _loc5_.var_398 = SkinLayoutEntity.const_361;
                  break;
               case "center":
                  _loc5_.var_398 = SkinLayoutEntity.const_1092;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_116:
               _loc10_ = 0;
               break;
