package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1775:uint = 0;
      
      public static const const_692:uint = 1;
      
      public static const const_1085:uint = 2;
      
      public static const const_905:uint = 4;
      
      public static const const_1543:uint = 8;
      
      public static const const_1678:uint = 16;
      
      public static const const_2070:uint = 64;
      
      public static const const_2080:uint = 128;
      
      public static const const_1176:uint = 256;
      
      protected static var var_578:uint = 0;
         ...
         if(this.var_875)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2138,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2138,16777215);
                  }
                  var_331 += bitmap.width * bitmap.height * 4;
               }
