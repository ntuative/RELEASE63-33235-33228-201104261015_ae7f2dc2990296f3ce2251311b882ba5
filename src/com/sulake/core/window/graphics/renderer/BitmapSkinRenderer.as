   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_838.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_838.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_838.blueMultiplier = (param1.color & 255) / 255;
               this.var_838.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_838);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_396 == SkinLayoutEntity.const_307)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_527)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_361)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_398 == SkinLayoutEntity.const_307)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_527)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_361)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_361 || _loc10_.var_396 == SkinLayoutEntity.const_361)
                  {
                  ...
                  {
                     this.var_279.a = REGION.width;
                     this.var_279.d = REGION.height;
                     this.var_279.tx = REGION.x;
                     this.var_279.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_279,ALPHA);
                  }
                  else
                  {
                     this.var_279.a = 0 / _loc18_.width;
                     this.var_279.d = 0 / _loc18_.height;
                     this.var_279.tx = 0;
                     this.var_279.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_279);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_279,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_396 == SkinLayoutEntity.const_307)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_398 == SkinLayoutEntity.const_307)
               {
