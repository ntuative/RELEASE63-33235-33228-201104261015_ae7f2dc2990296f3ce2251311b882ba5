package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_661:uint = 0;
      
      private static const const_1028:uint = 1;
      
      private static const const_1029:uint = 2;
      ...
      private var var_184:Rectangle;
      
      private var var_1073:Matrix;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1473 = 4294967295;
         this.var_966 = 0;
         this.var_838 = new ColorTransform();
         this.var_1073 = new Matrix();
         this.var_184 = new Rectangle();
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1029) : uint(const_661);
         var _loc6_:Boolean = this.var_184.width > 0 && this.var_184.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_966))
            {
               _loc5_ = const_1028;
            }
         }
         ...
         if(_loc5_ != const_661)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_1028)
               {
                  ...
                  if(this.var_638)
                  {
                     ...
                     _loc7_.draw(param1,this.var_120,this.var_120.rect,this.var_966,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1073.tx = param2.x;
                     this.var_1073.ty = param2.y;
                     this.var_838.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_120,this.var_1073,this.var_838,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
            ...
            this.var_184.left = int.MAX_VALUE;
            this.var_184.top = int.MAX_VALUE;
            this.var_184.right = int.MIN_VALUE;
            this.var_184.bottom = int.MIN_VALUE;
         }
         return true;
      }
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1473;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1258:
               ...
               break;
            case WindowRedrawFlag.const_815:
               this.var_966 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_966 != this.var_1473)
               {
                  this.var_638 = true;
                  _loc4_ = true;
               }
         ...
         if(_loc4_)
         {
            this.var_184.left = Math.min(this.var_184.left,param2.left);
            this.var_184.top = Math.min(this.var_184.top,param2.top);
            this.var_184.right = Math.max(this.var_184.right,param2.right);
            this.var_184.bottom = Math.max(this.var_184.bottom,param2.bottom);
         }
         return _loc4_;
      }
