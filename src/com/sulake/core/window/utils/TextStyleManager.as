package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_667:String = "{";
      
      private static const const_668:String = "}";
      
      private static const const_1437:String = "/*";
      
      private static const const_1436:String = "*/";
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "HabboAvatarRenderLib_HabboAvatarPetActions" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_667) != countSubStrings(param1,const_668))
         {
            throw new Error("Mismatching amount of \"" + const_667 + "\" versus \"" + const_668 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1437) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1436) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_667)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
