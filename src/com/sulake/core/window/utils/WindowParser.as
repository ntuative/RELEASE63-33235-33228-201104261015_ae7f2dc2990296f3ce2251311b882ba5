package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1105:String = "_EXCLUDE";
      
      public static const const_1988:String = "_INCLUDE";
      
      public static const const_1905:String = "_TEMP";
      
      private static const const_1418:String = "layout";
      
      private static const const_1025:String = "window";
      
      private static const const_1026:String = "variables";
      
      private static const const_1027:String = "filters";
      
      private static const const_450:String = "name";
      
      private static const const_1405:String = "style";
      
      private static const const_660:String = "params";
      
      private static const const_1410:String = "tags";
      ...
      private static const const_1404:String = "visible";
      
      private static const const_1412:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1150:String = "blend";
      
      private static const const_1414:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1415:String = "treshold";
      
      private static const const_1409:String = "children";
      
      private static const const_1407:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1408:String = "height_min";
      
      private static const const_1416:String = "height_max";
      
      private static const const_659:String = "HabboAvatarRenderLib_HabboAvatarPetActions";
      
      private static const const_170:String = "0";
      
      private static const const_1411:String = "$";
      
      private static const const_1413:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1417:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1406:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1340:Dictionary;
      
      protected var var_1341:Dictionary;
      
      protected var var_1075:Dictionary;
      
      protected var var_1614:Dictionary;
      
      protected var var_2137:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1340,this.var_1341);
         this.var_1075 = new Dictionary();
         this.var_1614 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1075,this.var_1614);
         this.var_2137 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1406,const_49);
         return param1.replace(const_1417,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1340)
            {
               delete this.var_1340[_loc1_];
            }
            for(_loc1_ in this.var_1341)
            {
               delete this.var_1341[_loc1_];
            }
            for(_loc1_ in this.var_1075)
            {
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1418)
         {
            _loc8_ = param1.child(const_1026);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1027).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1025);
         ...
         if(param1.localName() == const_1025)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1340[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_450,variables,"")));
         style = uint(this.parseAttribute(xml,const_1405,variables,style));
         params = uint(this.parseAttribute(xml,const_660,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1410,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1404,variables,visible.toString()) == const_659;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_660).length() > 0)
         {
            list = xml.child(const_660).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1075[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_450)) + "\"!");
               }
               params |= this.var_1075[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1412,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1413);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1026)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1407,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1408,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1416,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_659;
         blend = Number(this.parseAttribute(xml,const_1150,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1414,variables,window.clipping.toString()) == const_659;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1415,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1027).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function method_2(param1:IWindow) : String
      {
         var _loc8_:* = null;
         var _loc10_:* = null;
         var _loc12_:int = 0;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1105) == -1)
                  {
                     _loc11_ += this.method_2(_loc10_);
                  }
                  _loc12_++;
               }
            }
