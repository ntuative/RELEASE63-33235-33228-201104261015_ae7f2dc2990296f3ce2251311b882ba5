package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1071:uint = 4;
       
      
      protected var var_725:uint = 0;
      ...
      private var var_501:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_501 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_501.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_501.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1460 & const_1071)
         {
            if(_loc3_ == 0)
            {
               if(this.var_501.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_725 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_501.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_501.getStructByIndex(_loc8_);
