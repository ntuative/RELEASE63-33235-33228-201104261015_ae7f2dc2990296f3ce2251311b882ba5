   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_70 != null)
         {
            ...
            this.var_70.events.addEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_155,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_176,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_155,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_176,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_626.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_626.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_70 != null)
         {
            ...
            this.var_70.events.removeEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
            this.var_70 = null;
         }
         this.var_1069 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_945);
         _loc1_.push(RoomWidgetFurniActionMessage.const_705);
         ...
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_768);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1743);
         _loc1_.push(RoomWidgetPetCommandMessage.const_497);
         _loc1_.push(RoomWidgetPetCommandMessage.const_971);
         _loc1_.push(RoomWidgetUserActionMessage.const_486);
         _loc1_.push(RoomWidgetUserActionMessage.const_388);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_960);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_576)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_388 || param1.type == RoomWidgetUserActionMessage.const_486 || param1.type == RoomWidgetUserActionMessage.const_579)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_565:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_949,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_579:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_945:
            ...
            case RoomWidgetFurniActionMessage.const_274:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_705:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_833:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_768:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_380) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_380);
               }
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1236);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1072);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc29_ = "";
                  _loc30_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_741)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_422) == 0)
                  {
                     _loc32_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_422.length);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_210)
               {
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_470)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc18_ != null)
               {
                  _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.const_555);
               }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_113)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     _loc39_ = _loc18_.getModel().getString(RoomObjectVariableEnum.const_871);
                  ...
                  if(!_loc35_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_718;
                  }
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_891;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1652);
               }
               else
               {
               ...
               if(_loc21_ != null)
               {
                  _loc21_.setDirection(AvatarSetType.const_36,4);
                  _loc15_.image = _loc21_.getImage(AvatarSetType.const_36,true);
                  _loc21_.dispose();
               }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_626.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_626.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_871);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_70 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_379,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
