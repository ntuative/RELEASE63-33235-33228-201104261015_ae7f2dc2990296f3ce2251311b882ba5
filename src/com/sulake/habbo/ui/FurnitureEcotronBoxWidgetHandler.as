package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_726,RoomWidgetEcotronBoxOpenMessage.const_877,RoomWidgetEcotronBoxOpenedMessage.const_1542];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_726:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_877:
