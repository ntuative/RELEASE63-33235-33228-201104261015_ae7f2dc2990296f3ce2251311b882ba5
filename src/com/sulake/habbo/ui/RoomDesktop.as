package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_513:IAvatarRenderManager = null;
      ...
      private var var_1882:Boolean = true;
      ...
      private var var_2579:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_387,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_597,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_710,this.onRoomContentLoaded);
         }
      }
      ...
      public function set toolbar(param1:IHabboToolbar) : void
      {
         ...
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_584,this.onToolbarRepositionEvent);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_782.length)
            {
               _loc6_ = this.var_782.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_387,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_597,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_710,this.onRoomContentLoaded);
         }
         ...
         {
            this._toolbar.events.removeEventListener(HabboToolbarEvent.const_584,this.onToolbarRepositionEvent);
         ...
         {
            this.var_486.reset();
            this.var_486.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_486 = null;
         }
         this.var_1879 = null;
      }
      ...
      public function init() : void
      {
         ...
         if(this.var_312 != null && this.var_31.state == RoomSessionEvent.const_248)
         {
            this.var_1882 = !this.var_312.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1185.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_782.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc7_ = null;
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc7_ = this.var_781.getValue(_loc10_);
                  if(_loc7_ == null)
                  {
                     _loc7_ = [];
                     this.var_781.add(_loc10_,_loc7_);
                  }
                  else
                  {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc7_ = this.var_780.getValue(_loc11_);
                  if(_loc7_ == null)
                  {
                     _loc7_ = [];
                     this.var_780.add(_loc11_,_loc7_);
                  }
                  _loc7_.push(_loc4_);
               }
            }
         ...
         {
            param1 = "null";
            _loc12_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_205.roomViewRect);
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1216) == 1)
               {
                  _loc2_ = true;
                  if(this.var_424.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_876:
               ...
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_277,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_992 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_184)
                  {
                     this.var_992.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_571:
               ...
               break;
            case RoomEngineObjectEvent.const_787:
               if(!this.var_31.isRoomController && !this.var_424.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_136:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_690,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_161:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1129,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_617:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_405,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_714);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_930);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_831);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_942);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_141,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2579);
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_141:
               _loc3_ = "null";
               break;
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1879 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_309[0],_loc2_.width,_loc2_.height);
         if(this.var_486 == null)
         {
            this.var_486 = new Timer(const_1423,1);
            this.var_486.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_486.reset();
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1879));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1880) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.track("zoomEnded","HabboNavigatorCom_rico_tile_png",_loc3_);
               }
               else
               {
      ...
      public function update() : void
      {
         ...
         var _loc1_:int = this.var_364.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_364.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         if(this.var_16 != null && this.var_31 != null && this.var_1882 && this.var_1881)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_395);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_482:
               ...
               this.var_227 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_390,WindowStyle.const_1305,WindowParam.const_105) as IToolTipWindow;
      ...
      public function addUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         if(this.var_364.indexOf(param1) == -1)
         {
      ...
      public function removeUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         var _loc2_:int = this.var_364.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_364.splice(_loc2_,1);
         }
      }
   }
}
