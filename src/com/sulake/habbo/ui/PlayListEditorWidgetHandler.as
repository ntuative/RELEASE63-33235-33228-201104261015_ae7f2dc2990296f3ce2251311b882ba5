package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1483:IMessageEvent;
      
      private var var_1876:IMessageEvent;
      
      private var var_1875:IMessageEvent;
      ...
      {
         this.var_1483 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1876 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1875 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1483);
         this._connection.addMessageEvent(this.var_1876);
         this._connection.addMessageEvent(this.var_1875);
      }
      ...
      public function dispose() : void
      {
         ...
         this._connection.removeMessageEvent(this.var_1483);
         this._connection.removeMessageEvent(this.var_1876);
         this._connection.removeMessageEvent(this.var_1875);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_792,RoomWidgetPlayListModificationMessage.const_811,RoomWidgetPlayListModificationMessage.const_760,RoomWidgetPlayListPlayStateMessage.const_755,RoomWidgetPlayListUserActionMessage.const_786];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_792:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_839,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_811:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_760:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_755:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_786:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_235:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_852,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_682,-1));
            }
         }
      }
   }
