package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_944];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_944:
      ...
      {
         return [RoomSessionDoorbellEvent.const_125,RoomSessionDoorbellEvent.const_143,RoomSessionDoorbellEvent.const_61];
      }
