package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1424:String = "room_view";
      
      private const const_2133:String = "room_widget";
      
      private var var_49:IWindowContainer;
      
      private var var_786:int = 50;
      
      private var var_2935:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         if(param3)
         {
            if(param3.getKey("friendbar.enabled") == "HabboAvatarRenderLib_HabboAvatarPetActions")
            {
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(this.const_2133) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_49.getChildByTag(this.const_1424) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_786;
               _loc2_.width = this.var_49.desktop.width - this.var_786;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_786;
               _loc2_.height = this.var_49.desktop.height - this.var_786;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_49.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_49.findChildByTag(this.const_1424) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
