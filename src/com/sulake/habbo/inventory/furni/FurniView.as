package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2166:int = 0;
      
      private const const_1051:int = 1;
      
      private const const_1840:int = 2;
      
      private const const_1838:int = 3;
      
      private const const_1841:int = 42;
      
      private const const_1839:int = 120;
      ...
      private var var_807:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_407.add(FurniModel.const_47,new FurniGridView(this.var_66,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_407.add(FurniModel.const_50,new FurniGridView(this.var_66,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case FurniModel.const_47:
               ...
               this.var_408 = FurniModel.const_47;
               break;
            case FurniModel.const_432:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_408 = FurniModel.const_432;
               break;
            default:
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_407.getValue(this.var_408);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_66.getCategoryContent(this.var_408);
         if(!this.var_66.isListInited())
         {
            _loc2_ = this.const_1051;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_66.getGroupItemInIndex(_loc3_,this.var_408);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_272);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_292);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_276);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_807 && this.var_807.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1101)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1839)
         {
            _loc3_ = this.const_1839;
         }
         else if(_loc3_ < this.const_1841)
         {
            _loc3_ = this.const_1841;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_432);
            }
         }
      }
