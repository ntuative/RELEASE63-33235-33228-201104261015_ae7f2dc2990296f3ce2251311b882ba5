package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_432:String = "pets";
      ...
      private var var_1848:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_634 = new Timer(const_1401,1);
         this.var_634.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2528 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_634.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_634.stop();
               this.var_634 = null;
            }
            if(this.var_204 != null)
            {
               this.var_204.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_204.stop();
               this.var_204 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_47)
            {
               ...
               {
                  this.var_1848 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1848;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_963 == null)
         {
            this.var_963 = this._windowManager.buildFromXML(this.var_2528) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_963.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_204 = new Timer(param1,1);
            this.var_204.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_204.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_407);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_633.add(const_47,new Array());
         this.var_633.add(const_50,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_359;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_335 || _loc3_.category == FurniCategory.const_349 || _loc3_.category == FurniCategory.const_355)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_633.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_633.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_699)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
