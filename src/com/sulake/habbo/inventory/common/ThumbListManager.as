package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1350:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_579 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_579.width;
         this.var_90 = this.var_579.height;
         this.var_1082 = param5;
         this.var_880 = param6;
         this.var_218 = Math.floor(this.var_1082 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1082,this.var_880);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_580 = this.resolveRowCountFromList();
         if(this.var_580 == 0)
         {
            this.var_26 = new BitmapData(this.var_1082,this.var_880);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_218 * this._thumbWidth,this.var_1082),Math.max(this.var_580 * this.var_90,this.var_880),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_580)
         {
            _loc4_ = 0;
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1350.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_880)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_880);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_579.width,this.var_579.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_579.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_579,this.var_579.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
