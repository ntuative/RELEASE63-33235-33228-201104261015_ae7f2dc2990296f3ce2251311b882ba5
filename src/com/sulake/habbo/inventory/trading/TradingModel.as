package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1712:uint = 9;
      ...
      public static const const_313:uint = 3;
      
      public static const const_502:uint = 4;
      
      public static const const_275:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_56.updateItemList(this.var_764);
         this.var_56.updateItemList(this.var_1450);
      ...
      public function close() : void
      {
         if(this.var_773)
         {
            if(this._state != const_193 && this._state != const_275)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_765 + " OTHER: " + this.var_1157);
         ...
         {
            case const_193:
               if(param1 == const_213 || param1 == const_275)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1288);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_764)
            {
               this.var_765 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1157 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_56.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_764)
            {
               this.var_56.alertPopup(TradingView.const_1123);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_256.length < const_1712)
         {
