package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_701:BitmapData;
      
      protected var var_2630:int;
      
      protected var var_1610:Boolean;
      
      protected var var_2127:Boolean;
      
      protected var var_2899:BitmapData;
      
      private const const_2111:int = 8947848;
      
      private const const_2112:int = 13421772;
      
      private const const_1836:Number = 1;
      
      private const const_1835:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2898 == FurniModel.const_47)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1364));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2126);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_699)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1835;
               _loc1_.blend = this.const_1835;
            }
            else
            {
               this._window.blend = this.const_1836;
               _loc1_.blend = this.const_1836;
            }
         }
         if(this.isSelected)
         {
