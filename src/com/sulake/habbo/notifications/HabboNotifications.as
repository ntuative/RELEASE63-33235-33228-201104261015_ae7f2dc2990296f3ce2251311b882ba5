package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1483:String = "pixelbalance";
      
      private static const const_1486:String = "badges";
      
      private static const const_1485:String = "selectbadge";
      
      private static const const_1480:String = "inventory";
      
      private static const const_1484:String = "selectfurni";
      
      private static const const_1481:String = "credits";
      
      private static const const_1482:String = "friendlist";
      
      private static const const_1479:String = "pet_inventory";
      ...
      private var var_847:IHabboToolbar;
      ...
      private var var_235:HabboAlertDialogManager;
      
      private var var_848:ParkBusDialogManager;
      
      private var var_2823:Boolean;
      
      private var var_1045:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1046);
         }
         var _loc6_:Map = this.var_1046["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_847)
         {
            this.var_847.release(new IIDHabboToolbar());
            this.var_847 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1046["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1296.push(_loc8_);
         return this.var_1296.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1296.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_235 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_847 = IHabboToolbar(param2);
         this.var_847.events.addEventListener(HabboToolbarEvent.const_68,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_68)
         {
            ...
            this.var_392 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1046["styles"],this.var_1046["view"],this.var_847);
            ...
            registerUpdateReceiver(this.var_392,1);
            registerUpdateReceiver(this,2);
            this.var_424.events.addEventListener(BadgeImageReadyEvent.const_155,this.onBadgeImage);
            this.var_847.events.addEventListener(HabboToolbarEvent.const_584,this.onToolbarRepositionEvent);
         }
      }
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_392)
         {
            this.var_392.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1584[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_424);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1584[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1584[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_424.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1188,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1188,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1773,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_513.createAvatarImage(param2,AvatarScaleType.const_54);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_424.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_64)
               {
                  _loc7_ = this.var_424.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_424.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1807,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_64:
               ...
               break;
            case CatalogPageMessageProductData.const_204:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1126)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1562,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1597)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1048 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
      ...
      {
         var _loc2_:* = null;
         if(this.var_392.isSpaceAvailable() && this.var_1296.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_392.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1486:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_340);
               }
               break;
            case const_1485:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_392.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_235 == null)
         {
            return;
         }
         this.var_235.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_235.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_235.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_235.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_235.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_848 == null)
         {
            this.var_848 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_848 != null)
         {
            this.var_848.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1138,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1138,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_513.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_54);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2823)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1183,null);
            this.var_2823 = true;
      ...
      {
         if(param2.type == WindowEvent.const_179 || param2.type == WindowEvent.const_547)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1045 && this.var_1045.visible)
         {
            return;
         }
         this.var_1045 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1183,_loc6_);
      }
   }
}
