package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_548:int = 4;
      ...
      private static const const_457:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_2035 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_2035 = 15;
         }
         this.var_2036 = this._window.height;
         this.var_837 = 4;
         this.var_836 = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_466:
               ...
               _loc2_ = Number(this.var_1288) / Number(this.var_459["time_fade_in"]);
               if(this.var_1288 > int(this.var_459["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1061:
               ...
               if(this.var_1577 > int(this.var_459["time_display"]) && !this.var_2034)
               {
                  this.startFadeOut();
               }
               break;
            case const_1062:
               ...
               _loc3_ = 1 - Number(this.var_1287) / Number(this.var_459["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1287 > int(this.var_459["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2035;
         if(this._window.height < this.var_2036)
         {
            this._window.height = this.var_2036;
         }
      }
      ...
      {
         this.var_1287 = 0;
         this._state = const_1062;
      }
      
      private function startDisplay() : void
      {
         this.var_1577 = 0;
         this._state = const_1061;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this._toolbar.orientation == "TOP" ? int(const_457) : 0;
         var _loc4_:int = this._toolbar.orientation == "BOTTOM" ? int(_loc2_.height - const_457) : int(_loc2_.height);
         var _loc5_:int = this._toolbar.orientation == "LEFT" ? int(const_457) : 0;
         var _loc6_:int = this._toolbar.orientation == "RIGHT" ? int(_loc2_.width - const_457) : int(_loc2_.width);
         if(this.var_459["position_horizontal_follow_toolbar"] == "HabboAvatarRenderLib_HabboAvatarPetActions" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_548;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_548;
            }
         }
         else if(this.var_459["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_548;
         }
         else
         ...
         if(this.var_459["position_vertical_follow_toolbar"] == "HabboAvatarRenderLib_HabboAvatarPetActions" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_837;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_837;
            }
         }
         else if(this.var_459["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_837;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_836;
      }
   }
}
