package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_2106:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1437 = param7;
         this.var_2333 = param5;
         this.var_1783 = param6;
         this.var_58 = param10;
         this._assets = param8;
         this.var_424 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_155,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2442 = this.var_58.getBadgeName(this.var_301);
         this.var_2441 = this.var_58.getBadgeDesc(this.var_301);
         this.var_2439 = this.var_58.getAchievementNameForFacebook(this.var_301,this.var_424.userName,this.var_424.realName,this.var_1436);
         this.var_2440 = this.var_58.getAchievementDescForFacebook(this.var_301,this.var_424.userName,this.var_424.realName,this.var_1436);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2438 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_58.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_2001.toString());
         this.var_58.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1437.toString());
         this.var_58.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1437.toString());
         ...
         this.var_58.registerParameter(_loc16_,_loc17_,"" + this.var_2333);
         ...
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2106) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_58.registerParameter(param1,"badge_name",this.var_2442);
         this.var_58.registerParameter(param1,"badge_desc",this.var_2441);
         this.var_58.registerParameter(param1,"badge_name_fb",this.var_2439);
         this.var_58.registerParameter(param1,"badge_desc_fb",this.var_2440);
         this.var_58.registerParameter(param1,"level",this.var_1436.toString());
         this.var_58.registerParameter(param1,"name",this.var_424.userName);
         return this.var_58.registerParameter(param1,"realname",this.var_424.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_424.events.removeEventListener(BadgeImageReadyEvent.const_155,this.onBadgeImageReady);
            this.var_424 = null;
         }
         if(this._window != null)
         {
      ...
      {
         HabboWebTools.facebookAchievementPost(this.var_301,this._feedTitleFb,this.var_2438,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2443));
