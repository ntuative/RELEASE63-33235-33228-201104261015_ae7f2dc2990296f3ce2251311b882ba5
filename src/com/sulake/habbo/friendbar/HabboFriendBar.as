package com.sulake.habbo.friendbar
{
   ...
   public class HabboFriendBar extends ComponentContext
   {
      ...
      private function onConfigurationAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         var _loc3_:* = this.var_187.getKey("friendbar.enabled") == "HabboAvatarRenderLib_HabboAvatarPetActions";
         this.var_1218 = this.var_187.getKey("friend_bar.helper.friend_finding.enabled") == "HabboAvatarRenderLib_HabboAvatarPetActions";
         var _loc4_:* = this.var_187.getKey("client.toolbar.static.enabled","HabboRoomObjectLogicLib_manifest") == "HabboAvatarRenderLib_HabboAvatarPetActions";
         if(_loc3_)
         {
