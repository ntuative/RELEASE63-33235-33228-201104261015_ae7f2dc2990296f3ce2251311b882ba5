package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_294:Boolean = false;
      
      private static const const_646:String = "FriendBar";
      
      private static const const_645:String = "user_interaction";
      
      private static const const_1324:String = "visit_btn_click";
      
      private static const const_1323:String = "chat_btn_click";
      
      private static const const_1322:String = "find_friends_btn_click";
      
      private static const const_985:String = "Toolbar";
      
      private static const const_984:String = "open";
      
      private static const const_983:String = "close";
      
      private static const const_1320:String = "FRIENDLIST";
      
      private static const const_1321:String = "MESSENGER";
      ...
      private var var_406:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_406)
            {
               this.var_406.release(new IIDHabboMessenger());
               this.var_406 = null;
            }
            this.var_130 = null;
      ...
      {
         return this.var_294.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_82)
         {
            ...
            this.var_82.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_646,const_645,const_1324));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_406)
         {
            this.var_406.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_82)
            {
               this.var_82.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_646,const_645,const_1323));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_82)
         {
            ...
            this.var_82.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_646,const_645,const_1322));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         if(this.var_336)
         {
            if(!this.var_336.disposed)
            {
               ...
               if(this.var_82)
               {
                  this.var_82.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_985,const_1320,!!this.var_336.isOpen() ? const_984 : const_983));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_406)
         {
            ...
            {
               this.var_406.toggleMessenger();
               if(this.var_82)
               {
                  this.var_82.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_985,const_1321,!!this.var_406.isOpen() ? const_984 : const_983));
               }
            }
         }
      }
      ...
      {
         this.var_406 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_294.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_294.remove(_loc8_);
               this.var_130.splice(this.var_130.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_294.getValue(_loc4_.id);
            if(_loc3_)
            {
               if(_loc4_.online || const_294)
               {
               ...
               {
                  this.var_294.remove(_loc4_.id);
                  this.var_130.splice(this.var_130.indexOf(_loc3_),1);
               }
            }
            else if(_loc4_.online || const_294)
            {
               ...
               this.var_294.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_294)
            {
               if(this.var_294.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
                  this.var_130.push(_loc3_);
                  this.var_294.add(_loc3_.id,_loc3_);
         ...
         {
            this.var_130 = !!const_294 ? this.sortByNameAndOnlineStatus(this.var_130) : this.sortByName(this.var_130);
         }
