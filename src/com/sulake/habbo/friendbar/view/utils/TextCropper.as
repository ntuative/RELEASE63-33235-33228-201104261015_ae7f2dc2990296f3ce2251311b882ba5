package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class TextCropper implements IDisposable
   {
      ...
      private var var_1038:TextFormat;
      ...
      public function TextCropper()
      {
         ...
         this.var_1038 = this.var_548.defaultTextFormat;
      }
      ...
      {
         var _loc3_:int = 0;
         this.var_1038.font = param1.fontFace;
         this.var_1038.size = param1.fontSize;
         this.var_1038.bold = param1.bold;
         this.var_1038.italic = param1.italic;
         this.var_548.setTextFormat(this.var_1038);
         this.var_548.text = param1.getLineText(0);
         var _loc2_:int = this.var_548.textWidth;
         if(_loc2_ > param1.width)
         {
            _loc3_ = this.var_548.getCharIndexAtPoint(param1.width - this.var_2948,this.var_548.textHeight / 2);
