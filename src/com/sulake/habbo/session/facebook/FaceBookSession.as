package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1048:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1453:String = "sendAccessTokenToServer";
      
      private static const const_1452:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1453,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1452,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1048);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1048);
         }
      }
