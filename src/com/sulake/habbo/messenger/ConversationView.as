package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1495:int = 20;
       
      
      private var var_131:HabboMessenger;
      
      private var var_2849:IScrollbarWindow;
      
      private var var_2056:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_131 = param1;
         this.var_2056 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this._list = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2849 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1065 + const_1495)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1494;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_556 == null || _loc1_.id != this.var_556.id)
         {
            this.var_556 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_556.followingAllowed)
         {
            this.var_2056.enable();
         }
         else
         {
            this.var_2056.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this._list.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_556.messages.length - const_1065);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_556.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_556.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_853 || param3.type == Message.const_896 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_556.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_131.send(new FollowFriendMessageComposer(this.var_556.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_896)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1281)
         {
            return 4294927974;
         }
