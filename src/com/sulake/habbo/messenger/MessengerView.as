package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_897:ITextFieldWindow;
      
      private var var_15:IFrameWindow;
      
      private var var_1370:ConversationView;
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_15 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_131.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_57,HabboToolbarIconEnum.MESSENGER,this.var_15));
         }
         else
         {
            this.refresh();
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1370.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_896 = new ConversationsTabView(this.var_131,this.var_15);
         this.var_896.refresh();
         this.var_897 = ITextFieldWindow(this.var_15.findChildByName("message_input"));
         this.var_897.addEventListener(WindowKeyboardEvent.const_181,this.onMessageInput);
         this.var_1370 = new ConversationView(this.var_131,this.var_15);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_717,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1161,true);
         this.var_15.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc3_ = 120;
            _loc4_ = this.var_897.text;
            if(_loc4_.length > _loc3_)
            {
               this.var_897.text = _loc4_.substring(0,_loc3_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_897.text;
         ...
         this.var_897.text = "";
         this.var_131.conversations.addMessageAndUpdateView(new Message(Message.const_853,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
