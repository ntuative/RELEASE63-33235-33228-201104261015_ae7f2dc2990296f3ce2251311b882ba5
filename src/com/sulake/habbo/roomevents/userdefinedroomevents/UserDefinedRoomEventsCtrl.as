package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_326:int = 3;
      
      private static var var_1488:int = 2;
      ...
      private var var_1889:TriggerConfs;
      
      private var var_1888:ActionTypes;
      
      private var var_1890:ConditionTypes;
      
      private var var_263:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_783:RoomObjectHightLighter;
      ...
      {
         this.var_1889 = new TriggerConfs();
         this.var_1888 = new ActionTypes();
         this.var_1890 = new ConditionTypes();
         this.var_263 = new Dictionary();
         super();
         this.var_78 = param1;
         this.var_783 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_263[param1])
         {
            delete this.var_263[param1];
            this.var_783.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_36.furniLimit)
         {
            this.var_263[param1] = param2;
            this.var_783.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1187 = new SliderWindowController(this.var_78,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_78.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_783.hideAll(this.var_263);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_36.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_326)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_78.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_36.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_36 as TriggerDefinition != null)
         {
            this.var_78.send(new UpdateTriggerMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ActionDefinition != null)
         {
            this.var_78.send(new UpdateActionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ConditionDefinition != null)
         {
            this.var_78.send(new UpdateConditionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1488) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1488 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_78.send(new ApplySnapshotMessageComposer(this.var_36.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_326)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1889);
         this.refreshConfigureElement(this.var_1888);
         this.refreshConfigureElement(this.var_1890);
