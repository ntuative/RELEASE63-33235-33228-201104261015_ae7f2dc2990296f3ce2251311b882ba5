package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1884:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1502:IAvatarImage;
      ...
      private var var_1059:BitmapData;
      
      private var var_2877:ByteArray;
      
      private var var_2879:ImageData;
      
      private var var_881:PaletteMap;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_280.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_280.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_280.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_280.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_280.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_280.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_857 == GeometryType.const_1200 && param1 == GeometryType.const_1156 || this.var_857 == GeometryType.const_1156 && param1 == GeometryType.const_1200)
         {
            this.var_857 = param1;
            this.var_83 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_280.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_394.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_511)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1502.getFigure(),_loc5_,this.var_857,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_421 == null)
         {
            ...
            this.var_421 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_394);
            if(this.var_421 == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_280.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_280.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_83)
         {
            this.var_83 = this._structure.getCanvas(this._scale,this.var_857);
            if(!this.var_83)
            {
               return null;
            }
            this.var_2878 = new Point(0,this.var_83.height - int(this.var_83.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1719[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_917 || _loc10_ == AvatarAction.const_423;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1596 = this.var_124.bodyPartId;
               this.var_194 = this.var_124.partType;
               this.var_2070 = this.var_124.partId;
               ...
               this.var_1597 = this._scale + "_" + this.var_124.action.assetPartDefinition + "_" + this.var_194 + "_" + this.var_2070 + "_" + _loc5_ + "_" + this._frame;
               this.var_463 = this._assets.getAssetByName(this.var_1597) as BitmapDataAsset;
               if(this.var_463 == null)
               {
                  this.var_1597 = this._scale + "_std_" + this.var_194 + "_" + this.var_2070 + "_" + _loc5_ + "_0";
                  this.var_463 = this._assets.getAssetByName(this.var_1597) as BitmapDataAsset;
               }
               if(!(!this.var_463 || !this.var_463.content))
               {
                  ...
                  {
                     this.var_881 = this._structure.renderManager.paletteManager.getPalette(this.var_124.paletteMapId);
                     if(this.var_881 != null)
                     {
                        this.var_1059 = this.var_463.content as BitmapData;
                        this.var_193 = new BitmapData(this.var_1059.width,this.var_1059.height);
                        this.var_2877 = this.var_881.colorize(this.var_1059.getPixels(this.var_1059.rect));
                        this.var_193.setPixels(this.var_193.rect,this.var_2877);
                     }
                     else
                     {
                        this.var_193 = (this.var_463.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1596 == AvatarBodyPartType.const_256 || this.var_1596 == AvatarBodyPartType.const_1551 || this.var_1596 == AvatarBodyPartType.const_1763) && this.var_124.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  this.var_1061 = this.var_463.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_54)
                     {
                  ...
                  this.var_2879 = new ImageData(this.var_193,this.var_1061,_loc7_);
                  this.var_1060.push(this.var_2879);
               }
            }
            _loc8_--;
         }
         if(this.var_1060.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_1060,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2878.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_54)
            {
         ...
         _loc8_ = this.var_1060.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1060.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
