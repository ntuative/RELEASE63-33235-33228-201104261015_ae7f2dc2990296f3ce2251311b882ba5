package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1387:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1389:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_778:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1161:AvatarEditorHandler;
      ...
      private var var_961:IFigureData;
      ...
      private var var_1458:IHabboAvatarEditorDataSaver = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_512)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            this.var_631["null"] = new FigureData(this);
            this.var_631["null"] = new FigureData(this);
            _loc2_ = this.var_631["null"];
            _loc3_ = this.var_631["null"];
            _loc2_.loadAvatarData(const_1387,FigureData.const_80);
            _loc3_.loadAvatarData(const_1389,FigureData.FEMALE);
            this.var_102 = new Map();
            this.var_512 = new Map();
            this.var_102.add(AvatarEditorFigureCategory.const_926,new BodyModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_256,new TorsoModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_782,new LegsModel(this));
            ...
            this.var_512.add(AvatarEditorSideCategory.const_114,new WardrobeModel(this));
            this.var_512.add(AvatarEditorSideCategory.const_613,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_631[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_961.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_961.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_258 == null)
            {
               this.var_258 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_72,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_258.addChild(this._view.window);
               if(param5)
               {
                  this.var_258.center();
               }
            ...
            this.var_258.visible = !this.var_258.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_926);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_512.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_778 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_513 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_961 = this.var_513.getFigureData(AvatarType.const_129);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1161 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_631[this.var_947];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1458 != null)
         {
            ...
            this.var_1458.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1825;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1162 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1388)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1604.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_513.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_513.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1595)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1162 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1162 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_512.getValue(AvatarEditorSideCategory.const_114);
      }
