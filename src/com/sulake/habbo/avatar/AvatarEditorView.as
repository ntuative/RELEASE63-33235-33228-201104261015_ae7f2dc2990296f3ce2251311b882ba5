package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1604:IWindowContainer;
      
      public static var var_2085:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1232 = [];
         this.var_1406 = [AvatarEditorFigureCategory.const_926,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_256,AvatarEditorFigureCategory.const_782,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_114];
         super();
         ...
         if(var_1604 == null)
         {
            ...
            var_1604 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_440 = new Timer(1000);
         this.var_440.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1406;
         }
         for each(_loc6_ in param4)
         {
            this.var_1232.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1406);
         }
         if(param1.length != this.var_1232.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1232.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2661 = this.canChangeOutfit();
            this.var_440.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1232.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1406;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1955 == AvatarEditorSideCategory.const_114 || this.var_2659))
         {
      ...
      {
         if(this.var_1955 == AvatarEditorSideCategory.const_114)
         {
            this.var_2659 = false;
            this.setSideContent(AvatarEditorSideCategory.const_928);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_928:
               break;
            case AvatarEditorSideCategory.const_613:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_613);
               break;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2660 = new Date().valueOf();
                  this.var_2661 = false;
                  this.var_440.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_530)
         {
            ...
            this.var_530 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_530.procedure = this.stripClubDialogEventProc;
            this.var_530.center();
         }
         else
         {
            this.var_530.visible = true;
            this.var_530.center();
         }
      }
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2660 > 5000;
      }
   }
}
