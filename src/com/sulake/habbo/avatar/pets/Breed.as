package com.sulake.habbo.avatar.pets
{
   public class Breed extends PetEditorInfo implements IBreed
   {
      ...
      private var var_2764:Boolean = true;
      ...
      public function Breed(param1:XML)
      {
         ...
         this.var_2799 = parseInt(param1.@pattern);
         this.var_947 = String(param1.@gender);
         this.var_1535 = Boolean(parseInt(param1.@colorable));
         this.var_2800 = String(param1.@localizationKey);
