package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_280:AvatarImageCache;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1525);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_585);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_585);
                  _loc20_ = this.var_88;
                  _loc21_ = 1;
                  switch(this.var_88)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_585);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_585);
                  _loc21_ = this.var_88;
                  _loc22_ = 1;
                  switch(this.var_88)
                  {
         ...
         switch(param1)
         {
            case AvatarAction.const_374:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1741:
                  case AvatarAction.const_1798:
                  case AvatarAction.const_1716:
                  case AvatarAction.const_1171:
                  case AvatarAction.const_1222:
                  case AvatarAction.const_1570:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_327.push(new ActiveActionData(param1,param2));
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1524 = this._structure.sortActions(this.var_327);
         ...
         {
            this.var_743 = this._structure.getCanvasOffsets(this.var_1524,this._scale,this.var_88);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1524)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_423)
               {
                  this.var_921 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_247)
               {
                  this.var_921 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_316)
               {
                  this.var_921 = true;
               }
            }
