package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_862:PaletteManager;
      
      private var var_576:String;
      
      private var var_324:Map;
      
      private var var_237:AvatarAssetDownloadManager;
      
      private var var_2081:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_576 = RenderMode.const_1654;
         ...
         this.var_108.add(AvatarType.const_129,_loc4_);
         ...
         this.var_108.add(AvatarType.const_66,_loc4_);
         ...
         this.var_862 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_108.getValues())
            {
               _loc1_.dispose();
            }
         ...
         if(this.var_237)
         {
            this.var_237.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_325.init();
         this.var_862.init();
         _loc2_ = this.var_108.getValue(AvatarType.const_129) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_108.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_108.getValue(AvatarType.const_129) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_187.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_237 == null)
               {
                  ...
                  _loc6_ = this.var_187.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_187.getKey("flash.dynamic.avatar.download.url","");
                  this.var_237 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_237.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_977)
         {
            if(this.var_2889 && this.var_2890 && this.var_2888)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_237.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_237.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_108.getValue(AvatarType.const_129) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_237.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2081)
         {
            this.var_2081 = new AvatarFigureContainer(this.const_2164);
         }
         this.var_237.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2081,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_324.getKeys())
         {
            _loc4_ = this.var_324.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1552)
         {
            _loc6_ = !this.var_325.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_325.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_108.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_108.getValue(AvatarType.const_66);
      ...
      {
         var _loc2_:AvatarStructure = this.var_108.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_108.getValue(AvatarType.const_129) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_66:
               _loc3_ = this.var_108.getValue(AvatarType.const_66) as AvatarStructure;
               break;
            default:
