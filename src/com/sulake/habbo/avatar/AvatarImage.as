package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1315:String = "Default";
      
      private static const const_1316:int = 2;
      
      private static const const_1314:String = AvatarSetType.const_36;
      ...
      private var var_2155:String = null;
      
      private var var_2154:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_623 = param3;
         this.var_280 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1314,const_1316);
         this.var_327 = new Array();
         this.var_995 = new ActiveActionData(AvatarAction.const_416);
         this.var_995.definition = this._structure.getActionDefinition(const_1315);
         this.resetActions();
      ...
      {
         param2 += this.var_1622;
         if(param2 < AvatarDirectionAngle.const_1282)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_585,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_241.length == 1 && this.var_88 == this.var_1982)
         {
            return this.var_88 + this.var_479 + this.var_585 % 4;
         }
         if(this.var_241.length == 2)
         {
            for each(_loc1_ in this.var_241)
            {
               ...
               {
                  return this.var_88 + this.var_479 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_585 % 11;
                  return this.var_88 + "_" + this.var_1982 + this.var_479 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2156 || param2 != this.var_2155 || param1 != this.var_2154)
         {
            this.var_2156 = param3;
            this.var_2155 = param2;
            this.var_2154 = param1;
            this.var_1623 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1326 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1326)
            {
               this.var_46.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_585);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_585);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_327.length)
         {
            _loc3_ = this.var_327[_loc4_];
         ...
         this.var_327.push(new ActiveActionData(param1,param2,this.var_585));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_282 = this.var_995;
         this.var_282.definition = this.var_995.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_479 = "";
         this.var_241 = this._structure.sortActions(this.var_327);
         if(this.var_241 == null)
         {
            this.var_743 = new Array(0,0,0);
            if(this.var_1354 != "")
            {
               _loc1_ = true;
               this.var_1354 = "";
         ...
         {
            this.var_743 = this._structure.getCanvasOffsets(this.var_241,this._scale,this.var_88);
            for each(_loc4_ in this.var_241)
            {
               ...
               if(_loc4_.actionType == AvatarAction.const_348)
               {
                  ...
                  if(this.var_1355 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1355 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1354 != this.var_479)
            {
               _loc1_ = true;
               this.var_1354 = this.var_479;
            }
         }
         this.var_1353 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_241)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_921 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_209 = this.var_209.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1622 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_316 || _loc1_.actionType == AvatarAction.const_247 || _loc1_.actionType == AvatarAction.const_423)
               {
                  this.var_921 = true;
               }
            }
