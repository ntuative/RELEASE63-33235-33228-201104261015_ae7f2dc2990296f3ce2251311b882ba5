   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_219,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_293,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_254,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_262,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_271,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_66 && var_147 == "")
         {
            var_66.switchCategory(FigureData.const_219);
         }
      }
