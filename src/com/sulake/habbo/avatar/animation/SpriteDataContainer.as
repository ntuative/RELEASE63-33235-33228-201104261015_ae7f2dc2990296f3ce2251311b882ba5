package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2637:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2051 = parseInt(param2.@ink);
         this.var_2639 = String(param2.@member);
         this.var_2638 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1516 = [];
         this.var_1517 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1516[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1517[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1516.length)
         {
            return this.var_1516[param1];
         }
         return 0;
      }
      ...
      {
         if(param1 < this.var_1517.length)
         {
