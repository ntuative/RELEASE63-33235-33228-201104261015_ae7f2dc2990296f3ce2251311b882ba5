package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1626:Number = 1.0;
      ...
      {
         super();
         this.var_2051 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2834 = parseInt(_loc2_,16);
         this.var_2833 = parseInt(_loc3_,16);
         ...
         this.var_838 = new ColorTransform(this.var_1626,this.var_1629,this.var_1628,this._alphaMultiplier);
         this.var_1298 = this.generatePaletteMapForGrayscale(this.var_2833,this.var_2834);
      }
      ...
      {
         return this.var_1298.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1298.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1298.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1298.getValue("alphas") as Array;
      }
