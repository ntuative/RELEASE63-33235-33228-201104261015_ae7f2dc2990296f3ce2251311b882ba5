package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_452:AvatarRenderManager;
      ...
      private var var_1398:PartOffsetData;
      ...
      {
         this.var_1398.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_916 = new AvatarActionManager(param1,this.var_495,param2);
         this.var_995 = this.var_916.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         {
            if(this.var_495 == AvatarType.const_129)
            {
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return this.var_337.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_337.injectXML(param1);
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_337.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_337.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_916.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_916.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_916.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_601[param1])
         {
            this.var_601[param1] = new Dictionary();
         }
         if(this.var_601[param1][param2])
         {
            return this.var_601[param1][param2];
         }
         this.var_601[param1][param2] = this.var_337.getMandatorySetTypeIds(param1,param2);
         return this.var_601[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_337.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_916.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1624[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_337.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_337.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         return this.var_1398.getOffset(param1,param2,param3,param4,param5,param6);
      }
