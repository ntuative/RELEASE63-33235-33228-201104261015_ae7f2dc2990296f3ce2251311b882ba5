package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private static const const_1497:uint = 16777215;
      
      private static const const_1498:uint = 12247545;
      
      private static const const_1499:String = "HELP";
      
      private static const const_1500:String = "ROOMINFO";
      ...
      private const const_599:int = 44;
      ...
      public function LogoutController(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.hideRoomInfo();
         this.var_2059 = this._config.getKey("roominfo.widget.enabled") == "1";
         if(this.var_2059)
         {
            this._events.addEventListener(HabboToolbarEvent.const_309,this.onRoomView);
            this._events.addEventListener(HabboToolbarEvent.const_330,this.onHotelView);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_2059)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_309,this.onRoomView);
            this._events.removeEventListener(HabboToolbarEvent.const_330,this.onHotelView);
         }
         this._events = null;
         this._config = null;
         if(this._window)
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_633;
         _loc3_.y = this.const_599;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_686)
         {
            this.var_686 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1499);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1500);
               break;
            case "confirm":
               if(false)
               {
