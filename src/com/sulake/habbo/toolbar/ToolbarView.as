package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView implements IToolbarView
   {
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         this.var_223 = param2.createWindow("extrabar_container_window","",HabboWindowType.const_72,HabboWindowStyle.const_1080,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         this._window.tags.push("habbo_extrabar");
         if(param6.getKey("friendbar.enabled") == "HabboAvatarRenderLib_HabboAvatarPetActions")
         {
         ...
         this.var_1144 = String(_loc9_.relocate_by_drag.@state) == "HabboAvatarRenderLib_HabboAvatarPetActions";
         if(this.var_1144)
         {
         ...
         this.var_1143 = _loc9_.toolbar.@margin_top;
         this._toolbarMarginBottom = _loc9_.toolbar.@margin_bottom;
         this._toolbarMinGroupMargin = _loc9_.toolbar.@min_group_margin;
         this.var_1770 = _loc9_.toolbar.@margin_to_extrabar;
         this.var_310 = new ToolbarBarMenuAnimator(param2,this);
         var _loc10_:XMLList = XMLList(_loc9_.toolbar).children();
         var _loc11_:XMLList = XMLList(_loc9_.extras).children();
         this.createGroupsFromXmlList(_loc10_,this.var_252,param2,param3,param4,this._window,this.var_310);
         this.createGroupsFromXmlList(_loc11_,this.var_613,param2,param3,param4,this.var_223,this.var_310);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_156,this._config);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_156,this.var_500,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_156,this.var_500);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_156,this.var_500);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_938);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_613.length)
         {
            _loc2_ = this.var_613[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_223.x = this.var_156 + this.var_1770;
               this.var_223.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_223.x = 0;
               this.var_223.y = this.var_156 + this.var_1770;
         ...
         else
         {
            ...
            if(this.var_252.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.height - _loc5_ * _loc8_ - this.var_1143 - this._toolbarMarginBottom) / (this.var_252.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.width - _loc5_ * _loc8_ - this.var_1143 - this._toolbarMarginBottom) / (this.var_252.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1144 && this.var_1428)
         {
            ...
            if(_loc2_ != null && _loc2_ != this.var_500)
            {
               ...
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_584);
                  _loc3_.orientation = this.var_500;
