package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_223:Boolean = true;
      
      private static const const_1353:Number = 25;
      
      private static const const_1350:Number = 90;
      
      private static const const_1003:int = 50;
      
      private static const const_1358:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1410:IToolbarView;
      
      private var var_738:Timer;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:IToolbarView)
      {
         ...
         this.var_607 = new Object();
         this.var_606 = new Array();
         this.var_608 = new Array();
         super();
         this._windowManager = param1;
         this.var_1410 = param2;
         this.var_738 = new Timer(const_1353);
         this.var_738.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_343[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1003 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1003 || param1.desktop.height - param1.y < const_1358;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1410.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_343.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1410.getIconLoc(param1.iconId);
      ...
      {
         return this.var_606[this.var_608.indexOf(param1)];
      }
      
      private function method_7(param1:String) : String
      {
         return this.var_608[this.var_606.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_608.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_608.splice(_loc3_,1);
            this.var_606.splice(_loc3_,1);
         }
         this.var_606.push(param1.name);
         this.var_608.push(param2);
         param1.addEventListener(WindowEvent.const_236,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_209,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_607[_loc3_] == null)
            {
               this.var_607[_loc3_] = new Array();
            }
            if(this.var_607[_loc3_].indexOf(param1) < 0)
            {
               this.var_607[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_343.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_343.splice(this.var_343.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_606[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_608[_loc2_];
               if(this.var_607[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_607[_loc3_].length)
                  {
                     this.repositionWindow(this.var_607[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_343.length)
         {
            _loc2_ = this._itemList[this.var_343[_loc7_]];
            if(_loc2_.active)
            {
