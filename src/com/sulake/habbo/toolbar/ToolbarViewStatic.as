package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarViewStatic implements IToolbarView
   {
      ...
      private static const const_1313:uint = 7433577;
      
      private static const const_1312:uint = 5723213;
      
      private static const const_643:String = "_hover";
      
      private static const const_642:String = "_normal";
      ...
      public function ToolbarViewStatic(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         {
            this.setIconHoverState(_loc10_,const_642);
         }
         this.iconVisibility("QUESTS",false);
         this.iconVisibility("MEMENU",false);
         this.iconVisibility("INVENTORY",false);
         param5.addEventListener(HabboToolbarEvent.const_330,this.onToolbarStateEvent);
         param5.addEventListener(HabboToolbarEvent.const_309,this.onToolbarStateEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._events)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_330,this.onToolbarStateEvent);
            this._events.removeEventListener(HabboToolbarEvent.const_309,this.onToolbarStateEvent);
            this._events = null;
         }
      }
      ...
      private function onToolbarStateEvent(param1:HabboToolbarEvent) : void
      {
         switch(param1.type)
         {
            case HabboToolbarEvent.const_330:
               this.iconVisibility("QUESTS",false);
               this.iconVisibility("MEMENU",false);
               this.iconVisibility("INVENTORY",false);
               break;
            case HabboToolbarEvent.const_309:
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_643);
               this.setIconBgHoverState(_loc3_,const_643);
               break;
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_642);
               this.setIconBgHoverState(_loc3_,const_642);
         }
      }
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_643)
         {
            param1.color = const_1313;
         }
         else
         {
            param1.color = const_1312;
         }
      }
