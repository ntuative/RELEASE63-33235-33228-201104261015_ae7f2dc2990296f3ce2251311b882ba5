package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1197:BitmapData = null;
      ...
      {
         this.var_255 = param2 as IHabboCommunicationManager;
         if(this.var_255 == null)
         {
            return;
         }
         this._connection = this.var_255.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2614 = this._config.getKey("interstitial.enabled","HabboRoomObjectLogicLib_manifest") == "HabboAvatarRenderLib_HabboAvatarPetActions";
         this.var_2615 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2612 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1904 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_229 != null && this.var_229.running)
         {
            this.var_229.reset();
            return false;
         }
         if(this.var_1196 == 0)
         {
            this.var_1196 = getTimer();
            return false;
         }
         if(this.var_1904 > 0 && this.var_1905 >= this.var_1904)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1196;
         if(_loc1_ > this.var_2615)
         {
            ++this.var_1905;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1500 = _loc2_.imageUrl;
         this.var_2613 = _loc2_.clickUrl;
         this.var_1196 = getTimer();
         if(this.var_1500 != "")
         {
            _loc3_ = this.var_1500;
            ...
            {
               this.var_229 = new Timer(this.var_2612,1);
               this.var_229.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_229.running)
            {
               this.var_229.reset();
            }
            this.var_229.start();
            _loc4_ = new URLRequest(this.var_1500);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_569,0,0,param1.bitmapData,this.var_2613));
            this.var_1196 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_512));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1499 = _loc2_.imageUrl;
         this.var_1906 = _loc2_.clickUrl;
         if(this.var_1499 != "" && this.var_1906 != "")
         {
            _loc3_ = this.var_1499;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1499);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_615,0,0,_loc4_,_loc2_.assetName,this.var_1906,this.var_1197,this.var_1195));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1197 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_648.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_648.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_648.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_821,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_648.remove(_loc2_.assetName);
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_754,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
