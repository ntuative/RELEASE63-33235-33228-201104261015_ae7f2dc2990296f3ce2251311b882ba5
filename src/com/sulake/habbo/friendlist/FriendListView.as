package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1873:String = "noconvinfo";
      
      private static const const_1872:String = "messageinput";
      ...
      private var var_1536:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList, param2:IHabboConfigurationManager)
      {
         ...
         this.var_1536 = new FriendListTabsView(this._friendList);
         if(param2.getKey("client.toolbar.static.enabled","HabboRoomObjectLogicLib_manifest") == "HabboAvatarRenderLib_HabboAvatarPetActions")
         {
            this.var_1051 = true;
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1536.prepare(this.var_895);
         this.var_15.procedure = this.onWindow;
         this.var_15.content.setParamFlag(HabboWindowParam.const_1306,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_1180,true);
         this.var_15.header.setParamFlag(HabboWindowParam.const_921,false);
         this.var_15.header.setParamFlag(HabboWindowParam.const_969,true);
         this.var_15.content.setParamFlag(HabboWindowParam.const_921,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_969,true);
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1969 == -1 ? 0 : int(this.var_15.height - this.var_1969);
         var _loc4_:int = this.var_1968 == -1 ? 0 : int(this.var_15.width - this.var_1968);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1161,this._friendList.tabs.findSelectedTab() != null);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_921,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1306,false);
         ...
         this.var_1969 = this.var_15.height;
         this.var_1968 = this.var_15.width;
