package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2019:int = "F".charCodeAt(0);
      
      public static const const_2054:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_852 = param1.online;
         this.var_1714 = param1.followingAllowed && param1.online;
         this.var_623 = param1.figure;
         this.var_1713 = param1.motto;
         this.var_1715 = param1.lastAccess;
         this.var_1595 = param1.categoryId;
