package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2554:FriendListLookAndFeel;
      
      private var var_437:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1866:OpenedToWebPopup;
      ...
      private var var_1867:AvatarSearchResults;
      ...
      {
         this.var_2554 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_102 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1867 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1085)
         {
            this.var_1085.release(new IIDAvatarRenderManager());
            this.var_1085 = null;
         }
         ...
         if(this.var_778)
         {
            this.var_778.release(new IIDSessionDataManager());
            this.var_778 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1866 = new OpenedToWebPopup(this);
         }
         this.var_1866.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_358);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_328,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1085.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_187.getKey("client.minimail.embed.enabled");
         return _loc1_ == "HabboAvatarRenderLib_HabboAvatarPetActions";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_187.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this._view = new FriendListView(this,this.var_187);
         ...
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_1178,this.getText("friendlist.friends")));
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_441,this.getText("friendlist.friends.offlinecaption")));
         ...
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_102.findCategory(FriendCategory.const_441);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_437.findTab(FriendListTab.const_91).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_437.findTab(FriendListTab.const_91);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1867.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_437.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_778 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_778.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_778.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
