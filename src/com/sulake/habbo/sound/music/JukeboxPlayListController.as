package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_658 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            ...
            this.var_441 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         this.var_1817 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_324,HabboMusicPrioritiesEnum.const_127,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_766.indexOf(_loc5_) < 0)
               {
                  this.var_766.push(_loc5_);
                  this.var_70.requestSongInfoWithoutSamples(_loc5_);
               }
            }
            _loc7_.diskId = _loc6_;
            this.var_509.push(_loc7_);
            _loc4_++;
         }
         if(this.var_766.length == 0)
         {
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_947));
      }
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_509[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_766.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_766.splice(_loc3_,1);
         }
         if(this.var_766.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.PLAY_LIST_UPDATED));
