package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_958,this.onSoundMachinePlayEvent);
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_756,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_78)
            {
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_958,this.onSoundMachinePlayEvent);
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_756,this.onSoundMachineStopEvent);
               this.var_78 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_441);
