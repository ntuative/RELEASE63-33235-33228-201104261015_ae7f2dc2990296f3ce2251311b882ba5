package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1466:int = HabboMusicPrioritiesEnum.const_127;
      ...
      private var var_538:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_866,this.onJukeboxInit);
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_235,this.onJukeboxDispose);
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_964,this.onSoundMachineInit);
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_956,this.onSoundMachineDispose);
         ...
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_246)
         {
            this.var_539[_loc6_] = null;
            this.var_821[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2003)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_436)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_578,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this.var_451.length)
               {
                  _loc3_ = this.var_451.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_78)
            {
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_866,this.onJukeboxInit);
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_235,this.onJukeboxDispose);
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_964,this.onSoundMachineInit);
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_956,this.onSoundMachineDispose);
            }
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_451.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_246)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_671.add(param1,param2);
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_819));
         Logger.log("Requested song info\'s : " + this.var_819);
         this.var_819 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_451.add(_loc6_.id,_loc10_);
               ...
               while(this.var_820.indexOf(_loc6_.id) != -1)
               {
                  this.var_820.splice(this.var_820.indexOf(_loc6_.id),1);
                  if(this.var_820.length == 0)
                  {
                     this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_515));
                  }
               }
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_246)
         {
            return false;
         }
         ...
         this.var_2003 = this.getSongRequestCountAtPriority(param1);
         this.var_2002 = param2;
         if(this._priorityPlaying <= const_1466)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_127)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_538,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2747 != param1.id || _loc3_ > this.var_2746 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2747 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_671.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            if(this.var_451.getValue(_loc6_) == null)
            {
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_538 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_78,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_538 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
