package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1476:int = 60;
      ...
      private var var_549:Number = 1.0;
      ...
      private var var_1581:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_781,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1042.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1266:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1799:
               ...
               case HabboSoundTypesEnum.const_1169:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1615:
            ...
            this.var_1042.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_549;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_187.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_187.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_681.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1291.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_682,events);
         _loc5_.volume = this.var_549;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_682.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      {
         if(this.var_187 == null || this._connection == null || this._roomEngine == null || this.var_70 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1793,this.var_841));
         this.var_841 = -1;
         this.var_840 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_549 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_549 * 100)));
         }
      }
      ...
      {
         this.var_549 = param1;
         this.var_70.updateVolume(this.var_549);
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_681.remove(param1);
            if(this.var_682.getValue(_loc2_) == null)
            {
               this.var_1581.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1581,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1581,_loc2_,TraxSample.const_1758,TraxSample.const_1643);
               this.var_682.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1292.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1476 && this.var_1292.length > 0)
            {
               _loc3_ = this.var_1292.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_681.length == 0 && this.var_841 != -1)
            {
               this.var_840.ready = true;
               _loc4_ = this.var_841;
               this.var_841 = -1;
               this.var_840 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_781,_loc4_));
            }
         }
      }
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_840 == null && this.var_1291.length > 0)
         {
            _loc1_ = this.var_1291.getKey(0);
            _loc2_ = this.var_1291.remove(_loc1_);
            if(_loc2_ != null)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_781,_loc1_));
               }
               else
               {
                  this.var_840 = _loc2_;
