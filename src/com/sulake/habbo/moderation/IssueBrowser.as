package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2119:String = "open_issues";
      
      private const const_2121:String = "picked_issues";
      
      private const const_2167:String = "closed_issues";
      ...
      private var var_1797:IIssueBrowserView;
      
      private var var_1796:IIssueBrowserView;
      
      private var var_1798:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_254 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_254.numTabItems)
            {
               _loc5_ = this.var_254.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_58,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_254 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_254 == null || this.var_254.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_254.selector.getSelectableByName("open_issues");
         this.var_254.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_347.view.width = this.var_254.container.width;
         this.var_347.view.height = this.var_254.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2120:
               ...
               {
                  this.var_1797 = new MyIssuesView(this.issueManager,this,this.var_254.container);
               }
               return this.var_1797;
            case this.const_2119:
               if(this.var_1796 == null)
               {
                  this.var_1796 = new OpenIssuesView(this.issueManager,this,this.var_254.container);
               }
               return this.var_1796;
            case this.const_2121:
               if(this.var_1798 == null)
               {
                  this.var_1798 = new PickedIssuesView(this.issueManager,this,this.var_254.container);
               }
