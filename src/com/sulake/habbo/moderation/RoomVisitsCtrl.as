package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1043:Array = [];
      
      private static var var_2044:int = 200;
      ...
      {
         this.var_842 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1706;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1043.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_842.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1043.length < var_2044)
         {
            ...
            param1.width = this.var_842.width;
            param1.height = this.var_842.height;
