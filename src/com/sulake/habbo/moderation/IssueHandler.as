package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_503:UserInfoCtrl;
      
      private var var_1148:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_503 = new UserInfoCtrl(this._window,this.var_63,_loc3_.message);
         this.var_1148 = new UserInfoCtrl(this._window,this.var_63,_loc3_.message);
         this.var_503.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1148.load(_loc4_,this.var_157.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_63,WindowTracker.const_1242,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_503 = new UserInfoCtrl(this._window,this.var_63,_loc3_.message);
            this.var_503.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
