package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1008:ICheckBoxWindow;
      
      private var var_1534:ICheckBoxWindow;
      
      private var var_1533:ICheckBoxWindow;
      ...
      {
         return WindowTracker.const_1618;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1120 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1120);
         this.var_1120.procedure = this.onSelectTemplate;
         this.var_1008 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1534 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1533 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_33,WindowTracker.const_842,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_624 || this.var_516.text == "")
         {
            this.var_33.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1008.isSelected);
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1805,_loc2_,this.var_516.text,"",""));
         if(this.var_1534.isSelected || this.var_1533.isSelected || this.var_1008.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1534.isSelected,this.var_1533.isSelected,this.var_1008.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1728);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1693);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1120.selection];
         if(_loc3_ != null)
         {
            this.var_624 = false;
