package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_970:OffenceData;
      
      private var var_1177:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1177 = IButtonWindow(this.var_33.getXmlWindow("modact_offence"));
         this.var_1176 = IButtonWindow(this.var_33.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this.var_1175 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1175);
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this._frame.findChildByName("offence_txt").caption = this.var_970.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_969 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_969.offences,this.var_1177,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_33.initMsg.offenceCategories,this.var_1176,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModAlertMessageComposer(this.var_1478,this.var_516.text,this.var_1477));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_969 = this.var_33.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_970 = this.var_969.offences[_loc3_];
         this.var_516.text = this.var_970.msg;
         this.var_624 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModKickMessageComposer(this.var_1478,this.var_516.text,this.var_1477));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1175.selection < 0)
         {
            this.var_33.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_33.connection.send(new ModBanMessageComposer(this.var_1478,this.var_516.text,this.getBanLength(),this.var_1477));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1175.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1177.destroy();
            this.var_1177 = null;
         }
         if(this.var_1176 != null)
         {
            this.var_1176.destroy();
            this.var_1176 = null;
         }
         this.var_1175 = null;
         this.var_516 = null;
