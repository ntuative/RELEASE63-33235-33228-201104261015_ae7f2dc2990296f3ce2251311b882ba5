package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1799:int = 1000;
      
      private static var var_951:Array = [];
      
      private static var var_1800:int = 200;
      ...
      private var var_1754:IMessageComposer;
      ...
      public function show() : void
      {
         ...
         this.var_756 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         this.var_486 = new Timer(1000,1);
         ...
         this.var_33.connection.send(this.var_1754);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_756.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_952.length < var_1799)
         {
            ...
            param1.width = this.var_756.width;
            param1.height = this.var_756.height;
            var_952.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1801[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1444.getValue(param2.chatterName))
            {
               this.var_1444.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1444.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1442)
         {
