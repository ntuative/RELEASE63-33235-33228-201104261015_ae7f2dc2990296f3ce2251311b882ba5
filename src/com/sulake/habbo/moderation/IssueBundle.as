package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_805:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2431 = param2.pickerUserId;
         this.var_2672 = param2.pickerUserName;
         this.var_1503 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1233 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1234;
         }
         if(this.var_805 == null || param1.timeStamp < this.var_805.timeStamp)
         {
            this.var_805 = param1;
         }
         if(this.var_806 == null || param1.priority > this.var_806.timeStamp)
         {
            this.var_806 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1233 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1234;
            }
            if(this.var_805 == _loc2_)
            {
               this.var_805 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_806;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_805;
         if(_loc2_ == null)
         {
