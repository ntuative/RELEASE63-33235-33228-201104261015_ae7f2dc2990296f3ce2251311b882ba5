package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1643 ? 0 : 1,this._roomId),this.var_33,WindowTracker.const_842,this._roomId),this._frame,false,false,true);
      }
