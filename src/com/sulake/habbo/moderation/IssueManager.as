package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1268:String = "issue_bundle_open";
      
      public static const const_719:String = "issue_bundle_my";
      
      public static const const_1189:String = "issue_bundle_picked";
      
      public static const const_1550:int = 15000;
       
      
      private var var_63:ModerationManager;
      
      private var var_622:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_622 = new IssueBrowser(this,this.var_63.windowManager,this.var_63.assets);
         this.var_1151 = [];
         this.var_1152 = [];
         this.var_945 = new Map();
         this.var_2445 = parseInt(this.var_63.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1784 = new Timer(const_1550,0);
         this.var_1784.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1784.start();
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1152 = this.var_1152.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_63.soundManager.playSound(HabboSoundTypesEnum.const_1266);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_946.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_946.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1800)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_104)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_946.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2444++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_946.add(param1.issueId,_loc2_);
         ...
         {
            _loc6_ = this.getBundles(const_719);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1152.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2445);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_945.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_945.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_946.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_104.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_945.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_945.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_945.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
