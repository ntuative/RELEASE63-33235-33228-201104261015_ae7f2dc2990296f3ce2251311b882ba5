package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1222:ICheckBoxWindow;
      
      private var var_1225:ICheckBoxWindow;
      
      private var var_1226:ICheckBoxWindow;
      ...
      {
         if(param1 != this.var_374 || this.var_1219 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1219 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1519)
         {
            this.var_795.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1557)
         {
            this.var_795.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1583)
         {
            this.var_1224.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1786)
         {
            this.setTagError(this.var_988,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_989,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1757)
         {
            this.setTagError(this.var_988,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_989,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1717)
         {
            this.var_994.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_506,this.onDoorModePasswordUnselect);
         ...
         this.var_795 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1224 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_988 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_989 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_994 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1220 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1222 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1225 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1226 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         ...
         this.var_1221 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1934 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1522 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_266 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1223 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1521 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1521.mouseThreshold = 0;
         this.var_1521.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1223.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1934.visible = this._inRoom;
         if(this.var_796)
         {
            this.var_1221.visible = true;
            this.var_1522.visible = false;
            this.refreshFlatControllers();
            this.var_1221.height = Util.getLowestPoint(this.var_1221) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1227.visible = true;
            this.var_1522.visible = true;
            this._thumbnailContainer.visible = this._inRoom;
            this.var_1227.height = Util.getLowestPoint(this.var_1227) + 4;
         }
         this.var_1521.text = !!this.var_796 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1227.name,this.var_1221.name,this.var_1522.name,this.var_1934.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_795.setText(_loc1_.name);
         this.var_1224.setText(_loc1_.description);
         this.var_994.setText("");
         ...
         {
            case RoomSettingsData.const_191:
         ...
         this.setTag(this.var_988,_loc1_.tags[0]);
         this.setTag(this.var_989,_loc1_.tags[1]);
         if(this.var_1222)
         {
            if(_loc1_.allowPets)
            {
               this.var_1222.select();
            }
            else
            {
               this.var_1222.unselect();
            }
         }
         if(this.var_1225)
         {
         ...
         if(this.var_1226)
         {
            ...
            {
               this.var_1226.select();
            }
            else
            {
               this.var_1226.unselect();
            }
         }
         if(this.var_652)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.allowPets = this.var_1222.isSelected;
         _loc2_.allowFoodConsume = this.var_1225.isSelected;
         _loc2_.allowWalkThrough = this.var_1226.isSelected;
         _loc2_.hideWalls = this.var_652.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_988,_loc2_.tags);
         this.addTag(this.var_989,_loc2_.tags);
         this.clearErrors();
         this.var_1219 = _loc2_.roomId;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_168,HabboToolbarIconEnum.ROOMINFO));
      }
