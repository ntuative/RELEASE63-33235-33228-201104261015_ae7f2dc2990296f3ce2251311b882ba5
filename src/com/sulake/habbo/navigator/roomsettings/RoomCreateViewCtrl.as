package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1107:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,104,"a"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,94,"b"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,36,"c"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,84,"d"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"e"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"f"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,416,"i"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,320,"j"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,448,"k"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,352,"l"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,384,"m"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_53,372,"n"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1107.view.findChildByName("select_arrow"));
      ...
      private function prepare() : void
      {
         ...
         this.var_1106 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_180.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function refresh() : void
      {
         ...
         this.var_1106.input.textBackgroundColor = 4294967295;
         this.var_1107 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1106.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1106.getText();
         var _loc3_:String = "model_" + this.var_1107.name;
