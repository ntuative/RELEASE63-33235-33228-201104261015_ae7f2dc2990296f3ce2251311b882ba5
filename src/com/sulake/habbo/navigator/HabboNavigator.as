package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_426:RoomInfoViewCtrl;
      
      private var var_1158:RoomCreateViewCtrl;
      ...
      private var var_2976:Dictionary;
      ...
      private var var_2223:RoomThumbnailRenderer;
      
      private var var_994:GuestRoomPasswordInput;
      
      private var var_311:GuestRoomDoorbell;
      
      private var var_1159:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2498 = new Array();
         ...
         this.var_426 = new RoomInfoViewCtrl(this);
         this.var_1158 = new RoomCreateViewCtrl(this);
         this.var_2223 = new RoomThumbnailRenderer(this);
         this.var_994 = new GuestRoomPasswordInput(this);
         this.var_311 = new GuestRoomDoorbell(this);
         this.var_437 = new Tabs(this);
         this.var_1159 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_328,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_426.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_37)
         {
            ...
            {
               this.var_426.handleToolbarEvent(param1);
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_187.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_302.startSearch(Tabs.const_242,Tabs.const_392,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_302.startSearch(Tabs.const_300,Tabs.const_282);
         this.var_437.getTab(Tabs.const_300).tabPageDecorator.tabSelected();
      }
