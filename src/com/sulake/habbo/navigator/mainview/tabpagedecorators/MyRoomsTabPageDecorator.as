package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2975:IWindowContainer;
      
      private var var_508:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_508 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_508.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_508 == null ? 0 : int(this.var_508.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_875;
         }
         if(param1 == 2)
         {
            return Tabs.const_907;
         }
         if(param1 == 3)
         {
            return Tabs.const_950;
         }
         if(param1 == 4)
         {
            return Tabs.const_859;
         }
         return Tabs.const_282;
      }
   }
}
