package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2223 = new RoomThumbnailRenderer(param1);
         this.var_1258 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_178,this.var_110);
         if(this.var_110.ownerName != "" && this.var_110.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_178,!!this.var_110.event ? this.getEventCtg(this.var_110.categoryId) : this.getRoomCtg(this.var_110.categoryId));
         this.refreshRoomDesc(this.var_178,this.var_110);
         this.refreshExtraCont();
         this.refreshInfo(this.var_178,"trading_allowed",this.var_110.allowTrading);
         this.refreshInfo(this.var_178,"doormode_doorbell",this.var_110.doorMode == 1);
         this.refreshInfo(this.var_178,"doormode_password",this.var_110.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_178,this.var_110.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1258.refreshTags(_loc1_,this.var_110.tags);
         ...
         this.var_2223.refreshThumbnail(_loc1_,this.var_110.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_239,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
