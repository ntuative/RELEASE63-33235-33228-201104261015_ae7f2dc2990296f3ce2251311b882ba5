package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_685:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_685[this.var_1080] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
