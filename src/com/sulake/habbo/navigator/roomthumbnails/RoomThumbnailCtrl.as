package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1952:IButtonWindow;
      
      private var var_1951:IButtonWindow;
      
      private var var_1953:IButtonWindow;
      
      private var var_2657:IWindowContainer;
      
      private var var_2656:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1952 = IButtonWindow(this.find("bg_tab"));
         this.var_1951 = IButtonWindow(this.find("top_tab"));
         this.var_1953 = IButtonWindow(this.find("obj_tab"));
         this.var_2657 = IWindowContainer(this.find("tile_grid"));
         this.var_2656 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1952,this.onBgTabButton);
         Util.setProcDirectly(this.var_1951,this.onTopTabButton);
         Util.setProcDirectly(this.var_1953,this.onObjTabButton);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_66.mode = ThumbnailEditorModel.const_62;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1952,this.var_66.mode != ThumbnailEditorModel.const_40);
         this.setEnabled(this.var_1951,this.var_66.mode != ThumbnailEditorModel.const_62);
         this.setEnabled(this.var_1953,this.var_66.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2656;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_66.mode == ThumbnailEditorModel.const_40);
         this.refreshEditImg(_loc1_,"edit_top",this.var_66.mode == ThumbnailEditorModel.const_62);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_66.mode == ThumbnailEditorModel.const_35,false);
         if(this.var_66.mode == ThumbnailEditorModel.const_35)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2657;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_554)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_601,HabboWindowStyle.const_44,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_328,HabboWindowStyle.const_44,HabboWindowParam.const_63,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
