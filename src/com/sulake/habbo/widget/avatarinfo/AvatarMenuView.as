package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_974:uint = 0;
      
      protected static const const_641:uint = 1;
      
      protected static const const_1311:uint = 2;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_576:uint = 0;
      ...
      public function AvatarMenuView(param1:AvatarInfoWidget, param2:int, param3:String, param4:int, param5:int, param6:AvatarInfoData)
      {
         ...
         this._data = param6;
         var_1335 = XmlAsset(_widget.assets.getAssetByName("avatar_menu_widget")).content as XML;
      }
      ...
      override protected function createWindow() : void
      {
         ...
         _window = _widget.windowManager.buildFromXML(var_1335,0) as IWindowContainer;
         if(!_window)
         {
            return;
         }
      ...
      protected function updateButtons() : void
      {
         ...
         if(this.var_576 == const_974 || this.var_576 == const_641)
         {
            ...
            else
            {
               ...
               this.var_576 = const_641;
            }
         }
         if(this.var_576 == const_641)
         {
      ...
      private function toggleButtonElement(param1:IWindow, param2:Boolean) : void
      {
         ...
         {
            _loc3_ = IWindowContainer(param1).getChildByName("button");
            if(_loc3_)
            {
               if(param2)
               {
            ...
            if(_loc3_ is IWindowContainer)
            {
               _loc4_ = IWindowContainer(_loc3_).getChildByName("label");
               if(_loc4_)
               {
                  _loc4_.blend = !!param2 ? 1 : Number(0.5);
               }
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            else
            {
               ...
               {
                  case "link_moderate":
                     this.var_576 = const_1311;
                     this.updateButtons();
                     break;
                  case "link_show_actions":
                     this.var_576 = const_974;
                     this.updateButtons();
                     break;
