package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1319:int = 25;
      
      private static const const_982:int = 3;
      ...
      protected var var_2291:int;
      
      protected var var_1335:XML;
      
      protected var var_1336:Boolean;
      
      protected var var_2124:FixedSizeStack;
      
      protected var var_2125:int = -1000000;
      ...
      {
         this.var_2124 = new FixedSizeStack(const_1319);
         super();
         this._widget = param1;
         this._userId = param2;
         ...
         this.var_1335 = XmlAsset(this._widget.assets.getAssetByName("avatar_info_widget")).content as XML;
      }
      ...
      protected function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.buildFromXML(this.var_1335,0) as IWindowContainer;
         if(!this._window)
         {
            return;
         }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_832));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1336)
         {
            ...
            if(this.var_1609 == RoomObjectTypeEnum.const_184 || this.var_1609 == RoomObjectTypeEnum.const_470)
            {
            ...
            this.var_2124.addValue(_loc5_);
            _loc6_ = this.var_2124.getMax();
            if(_loc6_ < this.var_2125 - const_982)
            {
               _loc6_ = this.var_2125 - const_982;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2125 = _loc6_;
