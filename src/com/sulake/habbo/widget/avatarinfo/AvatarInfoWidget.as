package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      public function AvatarInfoWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboConfigurationManager, param4:IHabboLocalizationManager, param5:Component)
      {
         ...
         this.var_1476 = false;
         this.var_968 = false;
         this.var_1173 = new Timer(this.var_2931,1);
         this.var_1173.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_732,0,0));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_405,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_405,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_120:
               ...
               this.updateView(_loc2_.userId,_loc2_.userName,_loc2_.roomIndex,RoomObjectTypeEnum.const_184,_loc2_.allowNameChange,null);
               this.var_196 = true;
               break;
            ...
            case RoomWidgetUserInfoUpdateEvent.const_113:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_184,false,!!_loc3_.isSpectatorMode ? null : this.var_307);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_470,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.PET_INFO:
               _loc5_ = param1 as RoomWidgetPetInfoUpdateEvent;
               this.updateView(_loc5_.id,_loc5_.name,_loc5_.roomIndex,RoomObjectTypeEnum.const_210,false,null);
               break;
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_97:
               this.var_1865 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_405:
               this.var_1865 = true;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_968)
         {
            ...
            this.var_836 = 1 - this.var_1475 / Number(this.var_2932);
         }
         else
         {
            this.var_836 = 1;
         ...
         this._view.update(_loc2_.rectangle,_loc2_.screenLocation,this.var_836);
      }
   }
}
