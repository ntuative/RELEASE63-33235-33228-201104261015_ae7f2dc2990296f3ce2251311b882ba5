package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1865:String = "infostand_furni_view";
      
      private const const_1867:String = "infostand_pet_view";
      
      private const const_1864:String = "infostand_bot_view";
      
      private const const_1863:String = "infostand_jukebox_view";
      
      private const const_1868:String = "infostand_songdisk_view";
      ...
      private var var_436:InfoStandBotView;
      
      private var var_997:InfoStandJukeboxView;
      
      private var var_998:InfoStandSongDiskView;
      
      private var var_2649:Array;
      
      private var var_1526:InfostandUserData;
      ...
      private const const_2136:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1229 = new InfoStandFurniView(this,this.const_1865,this._catalog);
         this.var_185 = new InfoStandUserView(this,this.const_1866);
         this.var_376 = new InfoStandPetView(this,this.const_1867,this._catalog);
         this.var_436 = new InfoStandBotView(this,this.const_1864);
         this.var_997 = new InfoStandJukeboxView(this,this.const_1863,this._catalog);
         this.var_998 = new InfoStandSongDiskView(this,this.const_1868,this._catalog);
         this.var_1526 = new InfostandUserData();
         this.var_633 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_162 = new Timer(this.const_2136);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_176,this.onUserFigureUpdate);
         ...
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_379,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_176,this.onUserFigureUpdate);
         ...
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_379,this.onSongUpdate);
      }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_388,this.var_376.getCurrentPetId()));
      }
      ...
      {
         this.userData.setData(param1);
         this.var_436.update(param1);
         this.selectView(this.const_1864);
         if(this.var_162)
         {
            this.var_162.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_741)
         {
            this.var_997.update(param1);
            this.selectView(this.const_1863);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_422) != -1)
         {
            this.var_998.update(param1);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_185.setTags(param1.tags,this.var_2649);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_436.image = param1.image;
         }
         else
         {
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_436.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_171:
               ...
               {
                  _loc2_ = param1.id == this.var_1526.userRoomId;
                  break;
               }
               ...
               if(this.var_436 != null && this.var_436.window != null && this.var_436.window.visible)
               {
                  _loc2_ = param1.id == this.var_1526.userRoomId;
                  break;
               }
      ...
      {
         this.var_997.updateSongInfo(param1);
         this.var_998.updateSongInfo(param1);
      }
