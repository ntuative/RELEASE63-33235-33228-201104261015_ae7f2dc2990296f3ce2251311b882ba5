package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2151:int = 152;
      
      private const const_2153:int = 16;
      
      private const const_1501:int = 4;
      
      private const const_2156:uint = 14342874;
      
      private const const_2162:uint = 3815994;
      
      private const const_2161:uint = 2085362;
      
      private const const_2160:uint = 39616;
      
      private const const_2159:uint = 10513106;
      
      private const const_2155:uint = 8734654;
      
      private const const_2152:uint = 9094430;
      
      private const const_2157:uint = 6200576;
      
      private const const_2163:String = "happiness";
      
      private const const_2158:String = "experience";
      
      private const const_2154:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_47 == null || this.var_101 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_47.width,this.var_101.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_101.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2163,param1.nutrition,param1.nutritionMax,this.const_2160,this.const_2161);
         this.updateStateElement(this.const_2158,param1.experience,param1.experienceMax,this.const_2155,this.const_2159);
         this.updateStateElement(this.const_2154,param1.energy,param1.energyMax,this.const_2157,this.const_2152);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2151,this.const_2153,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2156);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2162);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1501,_loc7_.width - 2,_loc7_.height - 2 - this.const_1501);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1501);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_482) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_215 && this.var_215.getPetId() == this.var_482)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1553,true);
