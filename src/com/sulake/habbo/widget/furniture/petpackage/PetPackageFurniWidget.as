package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_468,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_468,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_498:
               this.hideInterface();
               this.var_361 = event.objectId;
               this.var_683 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_468:
               if(!this.var_1295)
               {
                  return;
               }
            ...
            case RoomWidgetPetPackageUpdateEvent.const_406:
               if(event.objectId != this.var_361)
               {
                  return;
               }
               this.var_683 = event.image;
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1295 || this.var_361 == -1)
         {
            return;
         }
         ...
         {
            this.var_1295 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_785,this.var_361,name);
