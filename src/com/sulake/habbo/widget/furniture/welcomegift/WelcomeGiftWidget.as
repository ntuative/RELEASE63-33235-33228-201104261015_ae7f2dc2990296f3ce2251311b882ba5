package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_649:String = "welcome_gift_email_unverified";
      
      private const const_995:String = "welcome_gift_email_verified";
      
      private const const_1345:String = "welcome_gift_email_change";
      
      private const const_2114:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1123)
         {
            this.setViewState(this.const_995);
         }
         else
         {
            this.setViewState(this.const_649);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_649:
               ...
               this._view.findChildByName("edit_text").visible = this.var_917;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_917);
               break;
            case this.const_995:
            ...
            case this.const_1345:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_917);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1400;
               _loc6_.focus();
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_895,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1123 ? this.const_995 : this.const_649);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1399 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1399));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_544,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_698,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_544,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_698,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_544:
               this.var_1400 = param1.email;
               this.var_1123 = param1.isVerified;
               this.var_917 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1400 = this.var_1399;
            this.setViewState(this.const_649);
         }
         else
         {
            if(param1.result == this.const_2114)
            {
               this.var_917 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1399);
