package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_517:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_517.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_517 = null;
         }
         if(this.var_46 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_325,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_325,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_517 == null)
         {
            this.var_517 = new Sprite();
            this.var_517.addChild(new Bitmap(this.var_46));
            this.var_517.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_517.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_46;
            }
         }
         _loc2_.setDisplayObject(this.var_517);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_325)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1153 != "")
         {
            HabboWebTools.openWebPage(this.var_1153);
         }
      }
   }
}
