package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_1856:int = 3;
      
      private const const_2125:uint = 4.291993382E9;
      
      private const const_2128:uint = 4.29080704E9;
      
      private const const_2126:uint = 4.285767869E9;
      
      private const const_2127:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1856;
            this._view.y = this.const_1856;
      ...
      {
         this.var_1809 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1809.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1809.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1808 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1808.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1808.toString();
         }
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1170));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2128;
      }
      
      private function onOrangeMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2125;
      }
      
      private function onBlueMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2127;
      }
      
      private function onBlueMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2126;
      }
   }
}
