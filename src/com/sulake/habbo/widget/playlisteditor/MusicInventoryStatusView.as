package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_933:String = "MISV_BUY_MORE";
      
      public static const const_734:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_1845:ITextWindow;
      
      private var var_1846:ITextWindow;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_461.getValues())
         {
            _loc1_.destroy();
         }
         this.var_461 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_461[param1] as IWindowContainer,0);
         this.var_45 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1846.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_734,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_933,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_461.add(const_734,_loc1_);
            this.var_1845 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1846 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_461.add(const_933,_loc1_);
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_461[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
