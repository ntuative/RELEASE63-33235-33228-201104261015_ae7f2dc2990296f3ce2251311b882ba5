package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_695:String = "PLSV_ADD_SONGS";
      
      public static const const_1215:String = "PLSV_START_PLAYBACK";
      
      public static const const_611:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_45 != const_611)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_461[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_461[const_695];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_461.add(const_611,_loc1_);
