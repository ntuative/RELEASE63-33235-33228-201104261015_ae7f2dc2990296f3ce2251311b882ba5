package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function setPreviewIconToPause() : void
      {
         if(this.var_98 != null)
         {
            this.var_98.playButtonState = MusicInventoryGridItem.const_1181;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_98 != null)
         {
            this.var_98.playButtonState = MusicInventoryGridItem.const_602;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_141;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_98.playButtonState == MusicInventoryGridItem.const_602)
               {
                  this.var_98.playButtonState = MusicInventoryGridItem.const_1269;
