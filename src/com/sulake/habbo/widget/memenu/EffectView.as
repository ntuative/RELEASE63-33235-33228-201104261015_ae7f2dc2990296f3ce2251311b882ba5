package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2117:int = 1000;
      ...
      private var var_935:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_207 = new Timer(this.const_2117);
         this.var_207.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_207.stop();
            this.var_207.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_207 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_181.isActive)
         {
            ...
            this.var_936.width = _loc2_ * this.var_291;
         }
         else
         {
            this.var_936.width = 0;
            this.var_207.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_740 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_740 == null)
            {
               return;
            }
         ...
         if(!this.var_181.isActive)
         {
            this.var_740.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_740.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_740.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_935 = this._window.findChildByName("effect_hilite");
            this.var_935.visible = false;
         }
         this.setTimeLeft();
         this.var_936 = this._window.findChildByName("loader_bar");
         if(this.var_936 != null)
         {
            this.var_291 = this.var_936.width;
            this.var_207.start();
            this.onUpdate();
         }
