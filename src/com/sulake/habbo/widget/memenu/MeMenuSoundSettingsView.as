package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_890:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_549 = param1.volume;
         if(this.var_890 != null)
         {
            this.var_890.setValue(this.var_549);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1663 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1664 = (_loc5_.content as BitmapData).clone();
         }
         this.var_890 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_722));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_549 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1663);
         }
         else
         {
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_549 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1661);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1664);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_887);
               break;
            default:
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_796);
         }
         else
         {
