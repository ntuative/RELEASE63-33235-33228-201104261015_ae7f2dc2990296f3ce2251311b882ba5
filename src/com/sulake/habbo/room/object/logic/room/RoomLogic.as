package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1653:int = 255;
      
      private var var_1424:uint = 16777215;
      
      private var var_1763:int = 255;
      
      private var var_1139:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_491,RoomObjectMouseEvent.const_151];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1158,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_856,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_957,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_711,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1140)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1653;
            if(_loc2_ - this.var_1140 >= this.var_1764)
            {
               _loc3_ = this.var_1139;
            ...
            else
            {
               ...
               _loc10_ = this.var_1139 >> 16 & 255;
               _loc11_ = this.var_1139 >> 8 & 255;
               _loc12_ = this.var_1139 & 255;
               _loc13_ = (_loc2_ - this.var_1140) / this.var_1764;
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_883:
               param2.setString(RoomObjectVariableEnum.const_292,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_953:
               param2.setString(RoomObjectVariableEnum.const_272,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_937:
               param2.setString(RoomObjectVariableEnum.const_276,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_568:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_278)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_707:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1267,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1274:
               param2.setNumber(RoomObjectVariableEnum.const_957,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1113:
               param2.setNumber(RoomObjectVariableEnum.const_711,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1116,int(param1.bgOnly));
         this.var_1424 = this._color;
         this.var_1763 = this.var_1653;
         this.var_1139 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_542,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1788,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1619,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1767,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_542,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_174 || _loc12_ == RoomPlaneData.const_339)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
