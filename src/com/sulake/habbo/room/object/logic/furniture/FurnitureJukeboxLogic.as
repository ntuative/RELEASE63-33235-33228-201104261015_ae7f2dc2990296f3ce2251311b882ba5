package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_546,RoomObjectFurnitureActionEvent.const_531,RoomObjectFurnitureActionEvent.const_493,RoomObjectFurnitureActionEvent.const_596,RoomObjectWidgetRequestEvent.const_159];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_380,RoomWidgetInfostandExtraParamEnum.const_741);
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  eventDispatcher.dispatchEvent(new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_89,_loc3_,_loc4_,-1));
               }
               break;
            default:
