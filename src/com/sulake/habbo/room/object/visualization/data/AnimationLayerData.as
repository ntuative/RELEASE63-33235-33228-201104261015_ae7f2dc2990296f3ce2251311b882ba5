package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_230.length)
         {
            _loc2_ = this.var_230[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_230.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_443 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         var _loc3_:* = null;
         param2 /= this.var_1965;
         var _loc4_:Boolean = false;
         var _loc5_:int = 0;
         if(!this.var_1740)
         {
            _loc6_ = param2 / this.var_443;
            param2 %= this.var_443;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_443 == 1)
            {
               param2 = this.var_443 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_230.length)
            {
               _loc3_ = this.var_230[_loc5_] as AnimationFrameSequenceData;
               if(_loc3_ != null)
               {
         ...
         _loc5_ = this.var_230.length * Math.random();
         _loc3_ = this.var_230[_loc5_] as AnimationFrameSequenceData;
      ...
      {
         if(param2 < 0 || param2 >= this.var_230.length)
         {
            return null;
         }
         var _loc5_:AnimationFrameSequenceData = this.var_230[param2] as AnimationFrameSequenceData;
         if(_loc5_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            {
               if(param3 == this.var_230.length - 1 && param4 == param2.frameCount - 1)
               {
                  _loc14_ = true;
               }
            }
