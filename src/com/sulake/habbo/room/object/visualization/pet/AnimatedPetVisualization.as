package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1054:int = 1000;
      
      private static const const_1460:String = "pet_experience_bubble_png";
      
      private static const const_1459:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1460) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_383 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_234);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_140);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_234);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1774 = _loc3_.getNumber(RoomObjectVariableEnum.const_393) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_201);
            if(!isNaN(_loc8_))
            {
               this.var_1982 = _loc8_;
            }
            else
            {
               this.var_1982 = direction;
            }
            this.var_1415 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2144 = _loc3_.getNumber(RoomObjectVariableEnum.const_948);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_689);
            if(_loc9_ != this.var_1983)
            {
               this.var_1983 = _loc9_;
               this.var_2715 = this.var_1983.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_383 != null)
         {
            ...
            if(this.var_1415 > 0)
            {
               ...
               if(_loc2_ < const_1054)
               {
                  this.var_383.alpha = int(Math.sin(_loc2_ / const_1054 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_383.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_383.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_253)
         {
            this.var_253 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_89,param1);
            this.setAnimationForIndex(const_1459,_loc3_);
         }
         if(param2 != this.var_1416)
         {
      ...
      {
         return super.getAdditionalSpriteCount() + const_674;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2715);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_674)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_674))
            {
               if(param2 >= FurnitureVisualizationData.const_582.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_582[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1982);
         }
         return direction;
      }
      ...
      {
         if(this.var_1015[param1] == null)
         {
            if(this._animationData.getTag(var_89,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1462)
            {
               this.var_1015[param1] = true;
            }
            else
            {
               this.var_1015[param1] = false;
            }
         }
         return this.var_1015[param1];
      }
   }
}
