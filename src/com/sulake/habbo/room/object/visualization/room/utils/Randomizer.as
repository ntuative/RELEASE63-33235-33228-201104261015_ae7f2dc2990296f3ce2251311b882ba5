package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2027:int = 16777216;
      ...
      public static function getArray(param1:int, param2:int) : Array
      {
         ...
         return _randomizer.method_5(param1,param2);
      }
      ...
      public function method_5(param1:int, param2:int) : Array
      {
         var _loc7_:int = 0;
      ...
      {
         var _loc1_:int = this.var_2955 * this.var_2050 + this.var_2956;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2049;
         this.var_2050 = _loc1_;
         return _loc1_;
      }
