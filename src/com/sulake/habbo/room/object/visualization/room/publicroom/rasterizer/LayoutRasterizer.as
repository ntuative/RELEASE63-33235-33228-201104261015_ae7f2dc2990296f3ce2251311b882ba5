package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_804:IGraphicAssetCollection;
      
      private var var_1812:XMLList;
      ...
      private var var_1236:Point = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_1004)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1531 = this.var_44.getValue(this.var_1004);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2674 = new Vector3d(-0.5,0.5,0);
         this.var_1003 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2674);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1236.x = _loc3_.x;
         this.var_1236.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_44.getValue(this.var_1004);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1964 = RoomObjectVariableEnum.const_1117;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1964 = RoomObjectVariableEnum.const_1082;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1235 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1235 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_44.getValue(this.var_1004);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2675 && param3 == this.var_2673)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1235 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1235 + this._adImgIndex);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_577;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = this.var_804.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1236.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1236.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_442.indexOf(_loc10_) >= 0 && this.var_1003)
            {
               param1 = this.var_442.indexOf(_loc10_);
               if(this.var_661[param1] != "")
               {
                  _loc9_ = this.var_804.getAsset(this.var_661[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_660[param1] != -1)
               {
                  param2.alpha = this.var_660[param1];
               }
               this.var_442.splice(param1,1);
               this.var_661.splice(param1,1);
               this.var_660.splice(param1,1);
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_442.push(param1);
            this.var_661.push("");
            this.var_660.push(param2);
         }
         else
         {
            this.var_660[_loc3_] = param2;
         }
      }
   }
}
