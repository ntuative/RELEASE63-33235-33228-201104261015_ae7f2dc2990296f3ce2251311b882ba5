package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1697:int = 0;
      ...
      private var var_927:IPlaneRasterizer = null;
      
      private var var_726:PlaneMaskManager = null;
      ...
      private var var_417:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2357 = param11;
         this.var_2360 = param12;
         this.var_926 = param6;
      }
      ...
      {
         return this._isVisible && this.var_735;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_927.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_417;
         if(_loc3_ == null)
         {
         ...
         if(this.var_735 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_340))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_318.length * param1.scale;
            _loc6_ = this.var_319.length * param1.scale;
            ...
            if(this.var_927 != null)
            {
               _loc3_ = this.var_927.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1732,this.var_2358,this.var_2359,this.var_2357,this.var_2360,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1900 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_735)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1402.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1402[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1127);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_155.z - originZ,this.var_115.z - originZ,this.var_84.z - originZ,this.var_114.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2362 = relativeDepth;
            this._isVisible = true;
            this.var_1900 = geometry.updateId;
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_128 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_128 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_926)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_341.length)
            {
               _loc5_ = this.var_341[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_250.length == this.var_928.length)
         {
            while(_loc1_ < this.var_250.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_928.length)
                  {
                     _loc7_ = this.var_928[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_341.length > this.var_1403.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_926 || this.var_250.length == 0 && this.var_341.length == 0 && !this.var_340 || this.var_726 == null)
         {
            return;
         }
         ...
         if(this.var_340)
         {
            ...
            while(_loc5_ < this.var_250.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc3_.leftSideLoc / this.var_318.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc3_.rightSideLoc / this.var_319.length;
                  _loc12_ = _loc3_.type;
                  this.var_726.updateMask(this.var_68,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_928.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_341.length)
            {
               _loc4_ = this.var_341[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc4_.leftSideLoc / this.var_318.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc4_.rightSideLoc / this.var_319.length;
                  _loc13_ = this.var_68.width * _loc4_.leftSideLength / this.var_318.length;
                  _loc14_ = this.var_68.height * _loc4_.rightSideLength / this.var_319.length;
                  this.var_68.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1403.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_340 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_221.copyChannel(param1,param1.rect,const_652,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_221.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_221,this.var_221.rect,const_652,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
