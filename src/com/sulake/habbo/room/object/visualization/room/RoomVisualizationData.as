package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_491:FloorRasterizer;
      
      private var var_727:WallAdRasterizer;
      
      private var var_492:LandscapeRasterizer;
      
      private var var_726:PlaneMaskManager;
      ...
      public function RoomVisualizationData()
      {
         ...
         this.var_491 = new FloorRasterizer();
         this.var_727 = new WallAdRasterizer();
         this.var_492 = new LandscapeRasterizer();
         this.var_726 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc8_ = _loc3_[0];
            this.var_491.initialize(_loc8_);
         }
         ...
         {
            _loc10_ = _loc5_[0];
            this.var_492.initialize(_loc10_);
         }
         var _loc6_:XMLList = param1.maskData;
         if(_loc6_.length() > 0)
         {
            _loc11_ = _loc6_[0];
            this.var_726.initialize(_loc11_);
         }
         return true;
      }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         this.var_726.initializeAssetCollection(param1);
         this.var_723 = true;
      }
