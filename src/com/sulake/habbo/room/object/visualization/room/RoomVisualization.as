package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1746:int = 16777215;
      
      public static const const_1536:int = 13421772;
      
      private static const const_979:int = 16777215;
      
      private static const const_977:int = 13421772;
      
      private static const const_978:int = 10066329;
      
      private static const const_976:int = 10066329;
      
      public static const const_1674:int = 16777215;
      
      public static const const_1669:int = 13421772;
      
      public static const const_1586:int = 10066329;
      ...
      private var var_1392:String = null;
      ...
      private var var_1084:uint = 16777215;
      ...
      private const const_2107:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1158);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1100);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_197)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_174)
            {
               ...
               {
                  _loc13_.color = const_976;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_979;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_977;
               }
               else
               {
                  _loc13_.color = const_978;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1770)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_128,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2069 + this.const_2107 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_332.length)
            {
               _loc11_ = this.var_587[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_332[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1631)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2163 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2169 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2165 / 255);
         ...
         var_176 = _loc7_.getUpdateID();
         this.var_2069 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1900)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1566 || _loc3_.y != this.var_2167 || _loc3_.z != this.var_2162 || param1.scale != this.var_2166))
            {
               this.var_1566 = _loc3_.x;
               this.var_2167 = _loc3_.y;
               this.var_2162 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_176 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1267);
            if(_loc3_ != this.var_2168)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2168 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_856));
            if(_loc4_ != this.var_1084)
            {
               this.var_1084 = _loc4_;
               this.var_2163 = this.var_1084 & 255;
               this.var_2169 = this.var_1084 >> 8 & 255;
               this.var_2165 = this.var_1084 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1116));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_176 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_272);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_292);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_276);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_957));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_711));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_939));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_332;
         if(this.var_332.length == 0)
         {
            _loc6_ = this.var_144;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_332.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_332.push(_loc12_);
                        this.var_587.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1632;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_128 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_278)
                              {
