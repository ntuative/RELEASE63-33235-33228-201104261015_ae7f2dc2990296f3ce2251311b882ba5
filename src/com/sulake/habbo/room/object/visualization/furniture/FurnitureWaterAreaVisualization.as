package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1503:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1313)
            {
      ...
      {
         if(this.var_2874 == param1 && this.var_2875 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1503)
            {
               this.var_2068 = _loc2_;
               this.var_2874 = param1;
               this.var_2875 = direction;
               return this.var_2068;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1313.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_562 + 2;
         var _loc4_:int = this.var_691 + 2;
         var _loc5_:int = 0;
         ...
         this.var_2067 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_462.length)
         {
            if(this.var_462[_loc5_] == true)
            {
               this.var_2067 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_692[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_692[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_562 == 0 || this.var_691 == 0)
         {
            ...
            this.var_562 = _loc2_.getNumber(RoomObjectVariableEnum.const_345);
            this.var_691 = _loc2_.getNumber(RoomObjectVariableEnum.const_410);
         }
         this.var_462 = [];
         this.var_692 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_562 * 2 + this.var_691 * 2)
         {
            this.var_462.push(false);
            this.var_692.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_562 + 2;
         var _loc2_:int = this.var_691 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_68,getSize(param3),this.var_462,this.var_692,assetCollection);
      }
