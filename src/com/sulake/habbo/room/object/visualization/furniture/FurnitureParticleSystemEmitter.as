package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1784:String = "cone";
      
      public static const const_1665:String = "plane";
      
      public static const const_1650:String = "sphere";
      ...
      private var var_1010:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_1009 = 0;
         this.var_904 = false;
         this.init(0,0,0,this._direction,this.var_2695,this.var_1010,this.var_2698,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1240.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_904 = true;
         if(this.var_1009 < this.var_1538)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2696)
         {
            switch(this.var_2697)
            {
               case const_1784:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1010,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1240.length);
         return this.var_1240[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1009 < this.var_1538)
         {
            if(this.age % this.var_2694 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1009 < this.var_1538)
         {
            ...
            this.y = (2 - this.var_269) * this.y - (1 - this.var_269) * this.lastY + this.var_1970 * this.var_1010 * this.var_1010;
         ...
         for each(_loc2_ in this.var_382)
         {
            ...
            _loc2_.y = (2 - this.var_269) * _loc2_.y - (1 - this.var_269) * _loc2_.lastY + this.var_1970 * this.var_1010 * this.var_1010;
