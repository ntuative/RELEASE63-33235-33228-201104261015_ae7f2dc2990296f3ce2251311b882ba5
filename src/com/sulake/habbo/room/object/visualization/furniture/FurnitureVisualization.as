package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1822:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2451:Number = NaN;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1441 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1441;
            this.var_1441 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_668 != spriteCount)
         {
            createSprites(this.var_668);
         }
         if(param2)
         {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_475 != _loc3_.getUpdateID() || param1 != var_89 || param2 != this.var_2451)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2455 = _loc3_.getNumber(RoomObjectVariableEnum.const_260);
            ...
            this.var_2403 = this.var_1153 != null;
      ...
      {
         if(this.var_2453 != param2 || this.var_2454 != param1)
         {
            this.var_949 = [];
            this.var_948 = [];
            this.var_755 = [];
            ...
            this.var_2452 = this.getSize(param1);
      ...
      {
         this.var_668 = param1;
         this.var_1791 = this.var_668 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_582.length)
         {
            return "";
         }
         var _loc3_:String = this.var_949[param2];
         var _loc4_:Boolean = this.var_948[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2452;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1791)
            {
               _loc6_ = FurnitureVisualizationData.const_582[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_949[param2] = _loc3_;
            this.var_948[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_749[param3] != null && !this.var_1790)
         {
