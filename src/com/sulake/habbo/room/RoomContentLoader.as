package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_912:String = "RCL_LOADER_READY";
      
      private static const const_363:String = "RCL_PUBLICROOM_";
      
      private static const const_1871:int = 0;
      
      private static const const_1051:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_455:String = "place_holder";
      
      private static const const_672:String = "wall_place_holder";
      
      private static const const_671:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_455;
      
      private static const const_670:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1050:String = "selection_arrow";
      ...
      private var var_1007:Map = null;
      
      private var var_444:Dictionary;
      
      private var var_1006:Map = null;
      
      private var var_210:PublicRoomData = null;
      
      private var var_1532:Map = null;
      
      private var var_663:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2678 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_1051)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2681 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2682 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2680 = param2.getKey("public.room.dynamic.download.url","");
         this._publicRoomLoadNameTemplate = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_1051;
         this.initFurnitureData();
      }
      ...
      private function initPetData() : void
      {
         ...
         {
            this.var_444[_loc3_] = _loc2_;
            this.var_1007.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_424.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_533.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_533.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_445.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_445.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_444)
            {
               delete this.var_444[_loc1_];
            }
            this.var_444 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_662.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_663.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_663.remove(_loc7_);
               this.var_663.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2679)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_912));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_532 != null)
         {
            ...
            this.var_532.add(param1,param2);
         }
         if(this.var_531 != null)
         {
            this.var_531.remove(param2);
            this.var_531.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_532 != null)
         {
            _loc2_ = this.var_532.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_531 != null)
         {
            _loc2_ = this.var_531.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_360;
         }
         return RoomObjectCategoryEnum.const_178;
      }
      ...
      {
         return [const_455,const_672,const_671,const_670,TILE_CURSOR,const_1050];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_446.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_662.getValue(param1) as String;
      ...
      {
         return this.var_1007.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1006[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_662.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      {
         if(this.var_210 != null && this.var_210.hasWorldType(const_363 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_237 || param1 == RoomObjectVisualizationEnum.const_66 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_663.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2680 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_27:
               this.var_446[param1] = _loc4_;
               break;
            case RoomObjectCategoryEnum.const_26:
               this.var_662[param1] = _loc4_;
               break;
            default:
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_387,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1532.getValue(param1) != null)
         {
            this.var_210 = this.var_1532.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_727,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2678.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_444[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_387,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_597,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_444[param1];
            this.var_1006.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1532.add(param1,_loc4_);
         this.var_210 = _loc4_;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_533.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_533.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_533.add(_loc5_,_loc4_);
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_445.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_445[_loc2_] != null)
         {
            _loc3_ = this.var_445.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_363 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_363 + param1) == RoomObjectCategoryEnum.const_82)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_210.getWorldHeightScale(const_363 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_210 != null)
         {
            return this.var_210.getWorldScale(const_363 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_446.add(param1,param2);
      }
   }
}
