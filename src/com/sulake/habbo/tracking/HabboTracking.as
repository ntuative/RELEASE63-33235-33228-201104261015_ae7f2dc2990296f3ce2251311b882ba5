package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1046:uint = 11;
      ...
      private var var_208:IHabboFriendList;
      
      private var var_1230:IHabboWindowManager;
      ...
      private var var_439:FramerateTracker = null;
      
      private var var_268:LatencyTracker = null;
      
      private var var_657:LagWarningLogger = null;
      
      private var var_656:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_439 = new FramerateTracker();
         this.var_268 = new LatencyTracker();
         this.var_657 = new LagWarningLogger();
         this.var_656 = new ToolbarClickTracker(this);
         this.var_1528 = new Array(const_1046);
         var _loc4_:int = 0;
         while(_loc4_ < const_1046)
         {
            this.var_1528[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1759,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1581,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_772,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1076,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1230)
            {
               this.var_1230.release(new IIDHabboWindowManager());
               this.var_1230 = null;
            }
            if(this.var_312)
            {
            ...
            if(this.var_208)
            {
               ...
               {
                  Component(this.var_208).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_208).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_208).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_208).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_208).events.removeEventListener(HabboFriendListTrackingEvent.const_373,this.onFriendlistTrackingEvent);
               }
               this.var_208.release(new IIDHabboFriendList());
               this.var_208 = null;
            }
            if(this.var_138)
            {
      ...
      {
         this.var_1528[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_187 = IHabboConfigurationManager(param2);
         if(this.var_187)
         {
            if(this.var_268 != null)
            {
               this.var_268.configuration = this.var_187;
            }
            if(this.var_267 != null)
            {
               this.var_267.configuration = this.var_187;
            }
            ...
            if(this.var_187)
            {
               ...
               {
                  this.var_657.configure(this.var_187);
               }
               if(this.var_439 != null)
               {
                  this.var_439.configure(this.var_187);
               }
               if(this.var_656 != null)
               {
                  this.var_656.configure(this.var_187);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_813,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_962,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_556,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_657 != null)
            {
               this.var_657.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_962)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1630);
         }
         else if(param1.type == HabboHotelViewEvent.const_556)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1660);
         }
         else if(param1.type == HabboHotelViewEvent.const_67)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1811);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1703);
               break;
            case HabboCommunicationEvent.const_813:
               this.trackLoginStep(HabboLoginTrackingStep.const_1647,String(this._communication.port));
               break;
      ...
      {
         this.var_1230 = IHabboWindowManager(param2);
         if(this.var_1230)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_187)
            {
               if(this.var_187.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_187.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1528)
                  {
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1077,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_208 = param2 as IHabboFriendList;
         Component(this.var_208).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_208).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_208).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_208).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_208).events.addEventListener(HabboFriendListTrackingEvent.const_373,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1076,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_772,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_312.events.addEventListener(AdEvent.const_615,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_317)
         {
            if(this.var_1950 < 1)
            {
               if(!this.var_314)
         ...
         else if(param1.type == RoomEngineEvent.const_308)
         {
            if(this.var_314)
            {
               this.var_314.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_439)
               {
                  ...
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_439.frameRate),_loc2_));
                  ++this.var_1950;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_656)
         {
            this.var_656.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_187 != null && !Boolean(this.var_187.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_657.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_529 > -1 && _loc2_ < this.var_529)
         {
            ++this.var_1948;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1948);
         }
         if(this.var_529 > -1 && _loc2_ - this.var_529 > 15000)
         {
            ++this.var_1949;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1949);
         }
         this.var_529 = _loc2_;
         if(this.var_267 != null)
         {
            this.var_267.update(param1,this.var_529);
         }
         if(this.var_268 != null)
         {
            this.var_268.update(param1,this.var_529);
         }
         if(this.var_439 != null)
         {
            this.var_439.trackUpdate(param1,this,this.var_529);
         }
         if(this.var_657 != null)
         {
            this.var_657.update(this.var_529);
         }
      }
   }
}
