package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1856 = int(this.var_187.getKey("latencytest.interval"));
         this.var_1855 = int(this.var_187.getKey("latencytest.report.index"));
         this.var_2546 = int(this.var_187.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1858 > this.var_1856)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1858 = getTimer();
         this.var_637.add(this.var_1471,this.var_1858);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1471));
         ++this.var_1471;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_637 == null || this.var_226 == null)
         {
            return;
         }
         ...
         if(this.var_226.length == this.var_1855 && this.var_1855 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1857) > this.var_2546 || this.var_1857 == 0)
            {
               this.var_1857 = _loc9_;
