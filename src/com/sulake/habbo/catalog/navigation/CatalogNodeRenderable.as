package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1463:Number = 4285716709;
      ...
      private var var_1991:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1991 == 4294967295)
            {
               this.var_1991 = _loc1_.color;
            }
            _loc1_.color = const_1463;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1676;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1794;
            }
         }
      }
      ...
      {
         this._list = navigator.catalog.windowManager.buildFromXML(var_1556) as IItemListWindow;
         if(this._list == null)
         {
