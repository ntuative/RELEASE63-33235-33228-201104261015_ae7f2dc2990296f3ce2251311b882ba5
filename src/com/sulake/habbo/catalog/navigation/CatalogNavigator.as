package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2984:String = "magic.credits";
      
      private var var_2953:String = "magic.pixels";
      
      private var var_2952:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_686,this.activateScrollbar);
            ...
            this._scrollBar.addEventListener(WindowEvent.const_209,this.deActivateScrollbar);
         }
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_389.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_389)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_389.indexOf(_loc6_);
            this.var_389.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      {
         this.openPage(this.var_2953);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2952,true);
      }
