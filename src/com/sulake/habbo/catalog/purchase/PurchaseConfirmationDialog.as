package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2132:int = 10;
      ...
      private const const_1842:uint = 4.293848814E9;
      
      private const const_1843:uint = 4.294967295E9;
      
      private const const_1498:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1753 = _loc1_.stuffTypes;
            this.var_785 = _loc1_.boxTypes;
            this.var_784 = _loc1_.ribbonTypes;
            this.var_1194 = this.var_1753[0];
            this.var_367 = this.var_785[0];
            this.var_368 = this.var_784[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_368 < 0)
         {
            this.var_368 = this.var_784.length - 1;
         }
         if(this.var_368 > this.var_784.length - 1)
         {
            this.var_368 = 0;
         }
         if(this.var_367 < 0)
         {
            this.var_367 = this.var_785.length - 1;
         }
         if(this.var_367 > this.var_785.length - 1)
         {
            this.var_367 = 0;
         }
         var _loc1_:int = this.var_785[this.var_367] * 1000 + this.var_784[this.var_368];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1194,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1498 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1753;
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_785[this.var_367]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_784[this.var_368]);
         this._catalog.purchaseProductAsGift(this.var_1497,this.var_91,this.var_1496,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1497,this.var_91.offerId,this.var_1496);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_103:
               ...
               for each(_loc7_ in this.var_224)
               {
                  ...
                  if(_loc5_.length >= this.const_2132)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2611 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_329:
      ...
      {
         if(this.var_264 == null || !this.var_264.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_264.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_264 == null)
         {
            this.var_264 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_647 == null)
         {
            this.var_647 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_647.procedure = this.suggestionsEventHandler;
         }
         if(this.var_264 == null || this.var_647 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_264.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_647.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1498;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1842) : uint(this.const_1843);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_264.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function method_1(param1:Boolean) : void
      {
         if(this._window == null)
         {
            return;
