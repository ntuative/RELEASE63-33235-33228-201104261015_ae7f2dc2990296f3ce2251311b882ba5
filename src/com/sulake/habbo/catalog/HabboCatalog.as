package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1137:IRoomSession;
      ...
      private var var_190:CatalogViewer;
      
      private var var_390:ICatalogNavigator;
      
      private var var_107:Purse;
      
      private var var_95:RecyclerLogic;
      
      private var var_142:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_234:PurchaseConfirmationDialog;
      
      private var var_321:ChargeConfirmationDialog;
      ...
      private var var_2811:Boolean = true;
      
      private var var_2812:Boolean = true;
      
      private var var_2047:Boolean = false;
      
      private var var_2810:GiftWrappingConfiguration;
      
      private var var_1293:ClubGiftController;
      ...
      private var var_845:IPurchasableOffer;
      
      private var var_1583:IDragAndDropDoneReceiver;
      
      private var var_87:PlacedObjectPurchaseData;
      
      private const const_1064:Point = new Point(100,20);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_234 == null)
            {
               this.var_234 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_234.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_390.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_187.getKey("client.credits.embed.enabled","HabboRoomObjectLogicLib_manifest") == "HabboAvatarRenderLib_HabboAvatarPetActions";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_187.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_424.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_424.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_64)
         {
            _loc3_ = this.var_424.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_107.getActivityPointsForType(Purse.const_202)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_723)
         {
            if(!this.var_424.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_190.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_390 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_190 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_190.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1064;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_290,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_90:
               this.var_2047 = param1.session.isPrivateRoom;
               this.var_1137 = param1.session;
               if(this.var_95 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_142 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1293 = new ClubGiftController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_190 != null)
         {
            this.var_190.catalogWindowClosed();
         }
         if(this.var_95 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_95.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_390.buildCatalogIndex(_loc2_);
         if(this.var_844 && this.var_844 != "")
         {
            this.var_390.openPage(this.var_844);
            this.var_844 = "";
            this.var_1044 = -1;
         }
         else if(this.var_1044 > -1)
         {
            this.var_390.openPageById(this.var_1044,this.var_2048);
            this.var_1044 = -1;
            this.var_2048 = -1;
            this.var_844 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:Array = _loc3_.localization.method_6.concat();
         ...
         this.var_190.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_190 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_190.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2811 && this._soundManager != null)
         {
         ...
         if(this.var_321 != null)
         {
            this.var_321.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_73,this.var_107.credits));
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1293.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_190.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_142 != null)
         {
            this.var_142.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_142 != null)
         {
            this.var_142.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_142 != null)
         {
            this.var_142.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2810 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_234 != null)
         {
            this.var_234.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_142.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_321 == null)
         {
            this.var_321 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_321.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_190.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "HabboAvatarRenderLib_HabboAvatarPetActions" == this.var_187.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_187.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_179)
         {
            _loc3_ = this.var_187.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_187.keyExists("catalog.drag_and_drop") || this.var_187.getKey("catalog.drag_and_drop") != "HabboAvatarRenderLib_HabboAvatarPetActions")
         {
            return false;
         }
         if(!this.var_1137 || !this.var_1137.isRoomOwner)
         {
            return false;
         }
         ...
         {
            case ProductTypeEnum.const_204:
               _loc3_ = false;
               break;
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_272);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_292);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_276);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1294 && param1.type == RoomEngineObjectEvent.const_169)
         {
            this.resetPlacedOfferData();
            if(this.var_845 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_87 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_845);
            _loc2_ = this.var_1583;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_845.productContainer.firstProduct;
            ...
            else if(_loc3_ == RoomObjectCategoryEnum.const_26)
            {
               switch(_loc4_.furnitureData.name)
               {
                  ...
                  case "wallpaper":
                  case "landscape":
                     this.updateRoom(_loc4_.furnitureData.name,_loc4_.extraParam);
                     break;
                  default:
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_351,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         ...
         if(this.var_87 != null)
         {
            ...
            {
               _loc1_ = this.var_845.productContainer.firstProduct;
               switch(_loc1_.furnitureData.name)
               {
                  case "floor":
                  case "wallpaper":
                  case "landscape":
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_87 && this.var_87.productClassId == param1.classId)
         {
            if(this.var_87.roomCategory == this._roomEngine.activeRoomCategory && this.var_87.roomId == this._roomEngine.activeRoomId)
            {
               ...
               if(param1.category == FurniCategory.const_335 || param1.category == FurniCategory.const_349 || param1.category == FurniCategory.const_355)
               {
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_187.getKey("image.library.catalogue.url");
