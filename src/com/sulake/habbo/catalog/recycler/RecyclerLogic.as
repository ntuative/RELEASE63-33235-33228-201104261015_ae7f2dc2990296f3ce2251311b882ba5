package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_617 != const_1012;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1780 != RecyclerStatusMessageEvent.const_1247;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_617 == const_448;
      }
      ...
      {
         this.var_617 = const_1011;
         this.var_116 = new Array(const_208);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1780)
         {
            case RecyclerStatusMessageEvent.const_1539:
               this.var_617 = const_448;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1247:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1790:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1126:
               if(this._view != null)
               {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_116.length < const_208)
         {
            return false;
         }
         var _loc1_:int = 0;
