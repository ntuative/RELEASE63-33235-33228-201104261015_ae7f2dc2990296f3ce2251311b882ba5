package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1043:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_262:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1043).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1043).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         if(this._view)
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_99,MouseCursorType.const_1094);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_262.select(this);
            this.var_635 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_635 != null && this.var_635 == param2)
         {
            _loc3_ = this.var_262.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_635 = null;
            }
