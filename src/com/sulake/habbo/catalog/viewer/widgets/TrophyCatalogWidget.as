package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1337:int = 16763904;
      
      private static const const_1335:int = 13421772;
      
      private static const const_1336:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_719);
            if(_loc3_ == null)
            {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1337);
         _loc2_.push(const_1335);
         _loc2_.push(const_1336);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_719);
            if(_loc3_ == null)
            {
