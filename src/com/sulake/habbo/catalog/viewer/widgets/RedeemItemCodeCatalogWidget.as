package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1054.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1054 = null;
         }
         if(this.var_1055 != null)
         {
            this.var_1055.removeEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
            this.var_1055 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1054 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1054 != null)
         {
            this.var_1054.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1055 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1055 != null)
         {
            this.var_1055.addEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
         }
         return true;
      }
