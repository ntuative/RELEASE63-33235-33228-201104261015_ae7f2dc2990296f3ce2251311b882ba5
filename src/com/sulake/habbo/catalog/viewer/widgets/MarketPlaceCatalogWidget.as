package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1543:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_534)
         {
            this.var_534.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_534 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         this.updateStatusDisplay(this.const_1860,_loc2_.length);
         if(!this.var_534)
         {
            this.var_534 = new Timer(25);
            this.var_534.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1247 = 0;
         this.populateList();
         this.var_534.start();
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1543.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_58)
