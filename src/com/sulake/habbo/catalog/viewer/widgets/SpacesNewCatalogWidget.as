package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_102[this.var_511]);
      ...
      {
         var _loc2_:int = this.var_768[this.var_511];
         var _loc3_:Offer = this.var_202[this.var_511][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_202[this.var_511][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_768[this.var_511] = (this.var_202[this.var_511] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_768[0];
         var _loc2_:int = this.var_768[1];
         var _loc3_:int = this.var_768[2];
         var _loc4_:Offer = this.var_202[0][_loc1_];
         var _loc5_:Offer = this.var_202[1][_loc2_];
         var _loc6_:Offer = this.var_202[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_431 || _loc1_.pricingModel == Offer.const_385))
            {
               continue;
            }
            ...
            while(this.var_202.length < this._groupNames.length)
            {
               this.var_202.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_202[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_202[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_202[this.var_511],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_768[this.var_511];
