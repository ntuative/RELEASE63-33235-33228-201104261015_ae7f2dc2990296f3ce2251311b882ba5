package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_375:IGridItem;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_722 >= 0 && this.var_722 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_722];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_722;
            if(this.var_722 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_543)
         {
            ++this.var_1705;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1705);
         }
      }
