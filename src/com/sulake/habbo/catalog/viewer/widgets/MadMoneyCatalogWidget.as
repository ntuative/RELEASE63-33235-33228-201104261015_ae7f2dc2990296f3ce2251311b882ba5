package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MadMoneyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1259:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1259.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.eventProc);
            this.var_1259 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1259 = _window.findChildByName("ctlg_madmoney_button") as IButtonWindow;
         if(this.var_1259 != null)
         {
         }
         return true;
