package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1559:IScrollbarWindow;
      
      protected var var_1941:XML;
      
      private var var_2732:Array;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1026 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1257 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1996 = new Point(this.var_86.x,this.var_86.y);
         this.var_537 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1559 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1997 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1026.text = _loc4_;
         this.var_1257.text = _loc5_;
         this.var_1026.height = this.var_1026.textHeight + 5;
         this.var_1257.y = this.var_1026.y + this.var_1026.height;
         this.var_1257.height = Math.max(130,this.var_1257.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_543:
                  _loc6_ = this.var_1997.clone();
                  if(this.var_537 != null)
                  {
                     this.var_537.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_537,this.var_1559,this.var_1941);
                     ...
                     case ProductTypeEnum.const_204:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_323,AvatarAction.const_496);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2732)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2732 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1996.x;
            this.var_86.y = this.var_1996.y;
            if(param3 != null)
            {
