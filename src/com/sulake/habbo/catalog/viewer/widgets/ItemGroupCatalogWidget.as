package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_202[this.var_511][this.var_768];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_511 = var_570.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_511];
         var _loc3_:Array = this.var_202[this.var_511] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_768 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_768] as Offer;
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_64 || _loc3_.productType == ProductTypeEnum.const_78)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_202[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
