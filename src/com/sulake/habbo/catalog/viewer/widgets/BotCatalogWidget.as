package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      {
         this.var_1376 = param1.botFigureData;
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var _loc3_:String = this.var_1376.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1688.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1376.getValue(this.var_718.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1688.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1376.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
