package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1821:String = "ctlg_";
      ...
      private var var_1149:ItemGridCatalogWidget;
      ...
      {
         var _loc2_:String = const_1821 + param1;
         ...
         this.var_1335 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1335) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1531:
               if(this.var_1149 == null)
               {
                  this.var_1149 = new ItemGridCatalogWidget(param1);
                  this.var_35.push(this.var_1149);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1789:
               ...
               break;
            case CatalogWidgetEnum.const_1544:
            ...
            case CatalogWidgetEnum.const_1661:
               ...
               break;
            case CatalogWidgetEnum.const_1528:
               this.var_35.push(new SpecialInfoWidget(param1));
               break;
            case CatalogWidgetEnum.const_1545:
