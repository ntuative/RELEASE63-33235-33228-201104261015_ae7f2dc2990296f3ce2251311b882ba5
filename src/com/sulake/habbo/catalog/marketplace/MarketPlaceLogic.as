package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1954:int = 1;
      
      public const const_2043:int = 2;
      
      public const const_2170:int = 3;
      ...
      private var var_234:MarketplaceConfirmationDialog;
      ...
      private var var_2754:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_234)
         {
            this.var_234 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_234.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2752,this.var_2753,this.var_2733,this.var_2751);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1954,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_534)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2469 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_2043,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2294 || param1.furniTypeId != this.var_2299)
         {
            return;
         }
