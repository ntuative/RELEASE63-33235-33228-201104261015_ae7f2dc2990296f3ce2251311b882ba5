package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_812)
         {
            this.var_812 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_812)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_811)
         {
            this.var_811 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_811)
            {
               return;
            }
