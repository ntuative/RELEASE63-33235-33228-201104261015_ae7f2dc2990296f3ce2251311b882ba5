package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_530:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_476,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_488,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_620,this.onTaskDoneEvent);
         if(this.var_33.sessionDataManager != null)
         {
            this.var_33.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_314,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1168 && this.var_1169 && this.var_1466;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_476,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_488,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_620,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
               this.var_33.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_314,this.onFigureUpdate);
            }
            this.var_33 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_476:
               this.var_1466 = true;
               if(this.var_45 != null && this.var_45.id == const_530)
               {
                  this.showView(const_96);
               }
               break;
            case HabboHelpTutorialEvent.const_488:
               ...
               break;
            case HabboHelpTutorialEvent.const_620:
               if(this.var_1852)
               {
                  this.var_1852 = false;
                  this.showView(const_96);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2484 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2483;
         this._window.width = _loc2_.width + this.var_2484;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      {
         this.var_1168 = true;
         if(this.var_45 != null && (this.var_45.id == const_382 || this.var_45.id == const_96))
         {
            this.showView(const_96);
         }
      }
