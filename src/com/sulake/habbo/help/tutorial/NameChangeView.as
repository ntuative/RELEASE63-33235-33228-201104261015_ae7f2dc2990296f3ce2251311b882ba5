   ...
   public class NameChangeView
   {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1975 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_812)
         {
            this.var_812 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_812)
            {
               return;
            }
            this._window.content.addChild(this.var_812);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_811)
         {
            this.var_811 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_811)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_811.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_535;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_535);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_866:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1067:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1066 || param1 == ChangeUserNameResultMessageEvent.var_1067)
         {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_535 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_535);
               break;
