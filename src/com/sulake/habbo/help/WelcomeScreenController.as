package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1523];
      }
      ...
      public function dispose() : void
      {
         if(this.var_138)
         {
            ...
            this.var_138.toolbar.events.removeEventListener(HabboToolbarEvent.const_938,this.onToolbarResized);
            this.var_138 = null;
         }
         ...
         {
            this.var_797.stop();
            this.var_797.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_797 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_138.toolbar.events.addEventListener(HabboToolbarEvent.const_938,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_797 = new Timer(_loc4_);
         this.var_797.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_797.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_197.y = this.var_138.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_197.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_138.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_138.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_297,false);
         _loc4_.height -= 20;
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1523 < this._notifications.length - 1)
         {
            ++this.var_1523;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_197);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_197,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_197.x;
            this._window.y = this.var_197.y;
            this.var_138.removeUpdateReceiver(this);
         }
      }
