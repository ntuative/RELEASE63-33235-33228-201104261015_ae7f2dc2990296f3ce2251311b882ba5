package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_510:IKeyExchange;
      
      private var var_959:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2499:PseudoRandom;
      ...
      private var var_225:HabboHotelView;
      
      private var var_1452:String = "";
      
      private const const_1857:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_630 = param1;
            this.var_57.initConnection(HabboConnectionType.const_253);
         }
      }
      ...
      {
         if(this.var_57 && this.var_151 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_225 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_151.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_151.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_225.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_151.getKey("use.sso.ticket") == "1";
         this.var_630 = this.var_151.getKey("sso.ticket",null);
         this.var_1818 = this.var_151.getKey("flash.client.url","");
         this.var_2500 = this.var_151.getKey("external.variables.txt","");
         if(this.var_225 == null)
         {
            this.var_225 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_552,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1111;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_253);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_813);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2499 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_97:
               ...
               this.var_1452 = _loc4_;
               this.var_225.loadBannerImage(_loc7_ + "?token=" + this.var_1452,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1111:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1592:
               this.var_959 = this.generateRandomHexString(30);
               this.var_510 = new DiffieHellman(new BigInteger(this.var_151.getKey("connection.development.prime"),16),new BigInteger(this.var_151.getKey("connection.development.generator"),16));
               this.var_510.init(this.var_959);
               _loc8_ = this.var_510.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_510.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_510.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2499);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1818,this.var_2500));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1857,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_630 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_630);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2501)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1452);
         ...
         this.var_510 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_510.init(_loc14_);
            _loc15_ = this.var_510.getPublicKey(10);
