package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_552:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_169.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_135,HabboWindowStyle.const_44,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1857,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_169.habboConfiguration.getKey("use.sso","HabboRoomObjectLogicLib_manifest") == "HabboAvatarRenderLib_HabboAvatarPetActions")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1857,"/");
         ...
         {
            dispatchEvent(new Event(const_552));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_145.removeEventListener(SSOTicket.const_372,this.onParsedTicketSuccess);
            this.var_145.removeEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
            this.var_145 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_145 = new SSOTicket(this.var_169.assets,_loc3_,_loc2_,param1);
         this.var_145.addEventListener(SSOTicket.const_372,this.onParsedTicketSuccess);
         this.var_145.addEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_169.flashClientUrl = this.var_145.flashClientUrl;
         this.var_169.ssoTicket = this.var_145.ticket;
         this.var_145.removeEventListener(SSOTicket.const_372,this.onParsedTicketSuccess);
         this.var_145.removeEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
         this.var_145 = null;
         dispatchEvent(new Event(const_552));
