package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1699:int = 0;
      ...
      private var var_2970:IRoomContentLoader;
      
      private var var_598:IRoomObjectFactory = null;
      
      private var var_489:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1116:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_599 = [];
         this.var_591 = [];
         events.addEventListener(RoomContentLoadedEvent.const_387,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_597,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_710,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_598 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_598 == null || this.var_489 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_599.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_598.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_598 != null)
         {
            return this.var_598.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_54.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_599.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_599.splice(_loc2_,1);
            }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_907.indexOf(_loc2_) < 0)
         {
            this.var_907.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_907.length > 0)
         {
            _loc2_ = this.var_907[0];
            this.var_907.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_54 == null || this.var_489 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_489.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_489.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_598.createRoomObjectLogic(_loc6_);
