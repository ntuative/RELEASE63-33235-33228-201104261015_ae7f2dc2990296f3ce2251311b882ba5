package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_922:Number = 64;
      
      public static const const_1213:Number = 32;
      ...
      private var var_2030:Number = 1.0;
      
      private var var_2029:Number = 1.0;
      
      private var var_94:Vector3d;
      
      private var var_456:Vector3d;
      
      private var var_2945:Number = -500.0;
      
      private var var_2946:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1285 = new Vector3d();
         this.var_454 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1286 = new Vector3d();
         this.var_2031 = 1;
         this.var_2030 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2029 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_454.assign(this.var_94);
         this.var_454.x *= this.var_455;
         this.var_454.y *= this.var_458;
      ...
      {
         if(this.var_455 != param1 * this.var_2031)
         {
            this.var_455 = param1 * this.var_2031;
            ++this.var_166;
         }
      }
      ...
      {
         if(this.var_458 != param1 * this.var_2030)
         {
            this.var_458 = param1 * this.var_2030;
            ++this.var_166;
         }
      }
      ...
      {
         if(this.var_457 != param1 * this.var_2029)
         {
            this.var_457 = param1 * this.var_2029;
            ++this.var_166;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_94.x /= this.var_455;
         this.var_94.y /= this.var_458;
         this.var_94.z /= this.var_457;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_456.x;
         var _loc3_:Number = this.var_456.y;
         var _loc4_:Number = this.var_456.z;
         this.var_456.assign(param1);
         this._direction.assign(param1);
         if(this.var_456.x != _loc2_ || this.var_456.y != _loc3_ || this.var_456.z != _loc4_)
         {
            ++this.var_166;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_172.assign(_loc25_);
            this.var_1285.assign(this.var_172);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_173.assign(_loc19_);
            this.var_172.assign(_loc20_);
            this.var_1285.assign(this.var_172);
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1286.assign(_loc22_);
         }
         else
         {
            this.var_1286.assign(_loc17_);
         }
         ++this.var_166;
      }
      ...
      {
         if(param1 == null || this.var_172 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_172,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_172);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_458;
         _loc2_.z *= this.var_457;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1286);
         if(_loc3_ < this.var_2945 || _loc3_ > this.var_2946)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_458;
            _loc2_.z *= this.var_457;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1286);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_94.x * this.var_455,this.var_94.y * this.var_458,this.var_94.z * this.var_457);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_172;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_455,param2.y * this.var_458,param2.z * this.var_457);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_455,param3.y * this.var_458,param3.z * this.var_457);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_455,param4.y * this.var_458,param4.z * this.var_457);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1213;
         }
         else
         {
            this.scale = const_922;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_922;
      }
