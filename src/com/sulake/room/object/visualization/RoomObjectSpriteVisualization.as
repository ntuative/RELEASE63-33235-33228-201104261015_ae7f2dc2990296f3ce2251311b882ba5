   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_209 != null)
         {
            ...
            {
               _loc1_ = this.var_209[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_804.removeReference();
         }
         this.var_804 = param1;
         if(this.var_804 != null)
         {
            this.var_804.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_209.length > param1)
         {
            _loc2_ = this.var_209[this.var_209.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
