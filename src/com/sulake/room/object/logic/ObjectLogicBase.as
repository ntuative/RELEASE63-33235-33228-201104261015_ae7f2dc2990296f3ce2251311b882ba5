package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_357:IRoomObjectController;
      ...
      {
         if(this.var_357 == param1)
         {
            return;
         }
         if(this.var_357 != null)
         {
            this.var_357.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_357 = param1;
            this.var_357.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_357 != null)
            {
               this.var_357.setLocation(param1.loc);
               this.var_357.setDirection(param1.dir);
            }
         }
      }
   }
